...
MySQL - 10.5.8-MariaDB : Database - auc_auth
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`auc_auth` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
CREATE TABLE `account` (
  ...
  `sec_pa` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timezone_offset` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `idx_username` (`username`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Account System';

/*Data for the table `account` */

insert  into `account`(`id`,`username`,`salt`,`verifier`,`session_key_auth`,`session_key_bnet`,`totp_secret`,`email`,`reg_mail`,`joindate`,`last_ip`,`last_attempt_ip`,`failed_logins`,`locked`,`lock_country`,`last_login`,`online`,`expansion`,`mutetime`,`mutereason`,`muteby`,`locale`,`os`,`recruiter`,`sec_pa`,`timezone_offset`) values 
(1,'UNIVERSE','∫µÂ∆rÚC—ì\r‘¶ú¡Ödî_∑˚¢0ÙNˇ≥/ó','q&◊‚FÈ∏}!—Ô∏4“db∆¬‡ÎiXIåßœÇ','Lëˆ“y£çÚ`≥\r∞2˘≤)5≤WŒàÂgåπ•åÃF1 ˚°«',NULL,NULL,'','','2026-07-01 02:28:27','127.0.0.1','127.0.0.1',0,0,'00','2026-07-01 02:49:39',0,2,0,'','',2,'Win',0,NULL,0);
...
CREATE TABLE `logs_ip_actions` (
  ...
  `ip` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '127.0.0.1',
  `systemnote` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Notes inserted by system',
  `unixtime` int(10) unsigned NOT NULL COMMENT 'Unixtime',
  `time` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Timestamp',
  `comment` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Allows users to add a comment',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Used to log ips of individual actions';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Account-Permission relation';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Default permission to assign to different account security levels';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Permission - Linked Permission relation';
...
CREATE TABLE `rbac_permissions` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Permission List';
...
(184,'Role: Beta Tester Sec Level Administrator'),
(185,'Role: Beta Tester Sec Level Gamemaster'),
(186,'Role: Beta Tester Sec Level Moderator'),
(187,'Role: Beta Tester Sec Level Player'),
(188,'Role: Beta Tester Administrator Commands'),
(189,'Role: Beta Tester Gamemaster Commands'),
(190,'Role: Beta Tester Moderator Commands'),
(191,'Role: Beta Tester Player Commands'),
...
(228,'Command: account set seclevel'),
...
(1700,'Command: item_templateall'),
(1701,'Command: creature_templateall'),
(1702,'Command: gameobject_templateall'),
(1703,'Command: templatenpc'),
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Realm System';
...
(1,'Azeroth Universe','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,66,10,0,0,12340);
...
(1,1782865659,0,0,'SyphrenaCore rev. 010280787c69 2026-06-27 05:09:54 +0200 (SyphrenaCore branch) (Win64, RelWithDebInfo, Static)'),
(1,1782866533,0,0,'SyphrenaCore rev. 010280787c69 2026-06-27 05:09:54 +0200 (SyphrenaCore branch) (Win64, RelWithDebInfo, Static)'),
(1,1782866635,0,0,'SyphrenaCore rev. 010280787c69 2026-06-27 05:09:54 +0200 (SyphrenaCore branch) (Win64, RelWithDebInfo, Static)'),
(1,1782866763,0,0,'SyphrenaCore rev. 010280787c69 2026-06-27 05:09:54 +0200 (SyphrenaCore branch) (Win64, RelWithDebInfo, Static)'),
(1,1782866944,0,0,'SyphrenaCore rev. 010280787c69 2026-06-27 05:09:54 +0200 (SyphrenaCore branch) (Win64, RelWithDebInfo, Static)');
