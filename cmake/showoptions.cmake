...
message("")
message("* SyphrenaCore revision   : ${rev_hash} ${rev_date} (${rev_branch} branch)")
if(UNIX)
  message("* SyphrenaCore buildtype  : ${CMAKE_BUILD_TYPE}")
endif()
message("")
...
if(WITH_COREDEBUG)
  ...
  add_definitions(-DSYPHRENA_DEBUG)
else()
...
if(BUILD_SHARED_LIBS)
  ...
  add_definitions(-DSYPHRENA_API_USE_DYNAMIC_LINKING)
