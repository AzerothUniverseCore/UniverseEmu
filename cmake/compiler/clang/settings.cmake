...
if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS CLANG_EXPECTED_VERSION)
  message(FATAL_ERROR "Clang: SyphrenaCore requires version ${CLANG_EXPECTED_VERSION} to build but found ${CMAKE_CXX_COMPILER_VERSION}")
else()
...
if (NOT CLANG_HAVE_PROPER_CHARCONV)
  ...
  target_compile_definitions(syphrena-compile-option-interface
  INTERFACE
    -DSYPHRENA_NEED_CHARCONV_WORKAROUND)
endif()
...
if(BUILD_SHARED_LIBS)
  ...
  # (caused through missing SYPHRENA_*_API macros).
