...
class SC_DATABASE_API TransactionBase
{
    ...
    public:
        ...
        void PAppend(Syphrena::FormatString<Args...> sql, Args&&... args)
        {
            this->Append(Syphrena::StringFormat(sql, std::forward<Args>(args)...).c_str());
        }
...
/*! Low level class*/
class SC_DATABASE_API TransactionTask : public SQLOperation
{
...
class SC_DATABASE_API TransactionWithResultTask : public TransactionTask
{
public:
...
class SC_DATABASE_API TransactionCallback
{
public:
