...
#ifndef SYPHRENA_FIELD_VALUE_CONVERTERS_H
#define SYPHRENA_FIELD_VALUE_CONVERTERS_H
...
public:
    ...
    {
        return Syphrena::StringTo<DatabaseType>({ data, size }).template value_or<DatabaseType>(0);
    }
...
#endif // SYPHRENA_FIELD_VALUE_CONVERTERS_H
