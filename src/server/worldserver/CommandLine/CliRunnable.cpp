...
#if SYPHRENA_PLATFORM != SYPHRENA_PLATFORM_WINDOWS
namespace Syphrena::Impl::Readline
{
    ...
    char** cli_completion(char const* text, int /*start*/, int /*end*/)
    {
        ...
        vec = Syphrena::ChatCommands::GetAutoCompletionsFor(CliHandler(nullptr,nullptr), text);
...
void CliThread()
{
    ...
    PrintCliPrefix();
#else
    ::rl_attempted_completion_function = &Syphrena::Impl::Readline::cli_completion;
    {
        static char BLANK = '\0';
        ::rl_completer_word_break_characters = &BLANK;
    }
    ::rl_event_hook = &Syphrena::Impl::Readline::cli_hook_func;
#endif
