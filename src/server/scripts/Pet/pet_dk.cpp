...
struct npc_pet_dk_ebon_gargoyle : CasterAI
{
    ...
    void InitializeAI() override
    {
        ...
        Syphrena::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 30.0f);
        Syphrena::UnitListSearcher<Syphrena::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
