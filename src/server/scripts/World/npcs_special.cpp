...
public:
    ...
    struct npc_midsummer_bunny_poleAI : public ScriptedAI
    {
        ...
        bool checkNearbyPlayers()
        {
            ...
            Syphrena::UnitAuraCheck check(true, SPELL_RIBBON_DANCE_COSMETIC);
            Syphrena::PlayerListSearcher<Syphrena::UnitAuraCheck> searcher(me, players, check);
        ...
        if (SummonPatientTimer <= diff)
        {
            ...
            switch (me->GetEntry())
            {
                ...
                case DOCTOR_HORDE:
                    ...
                    break;
                default:
                    SC_LOG_ERROR("scripts", "Invalid entry for Triage doctor. Please check your database");
                    return;
            }
            ...
            switch (eventId)
            {
                ...
                case EVENT_FACE_TO:
                {
                    ...
                    if (!_revelerGuids.empty())
                        if (Creature* creature = ObjectAccessor::GetCreature(*me, Syphrena::Containers::SelectRandomContainerElement(_revelerGuids)))
                ...
                case EVENT_EMOTE:
                    ...
                    if (roll_chance_i(50))
                    {
                        me->HandleEmoteCommand(Syphrena::Containers::SelectRandomContainerElement(BrewfestRandomEmote));
