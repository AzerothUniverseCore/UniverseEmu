# Transmogrification Display Vendor [![Build Status](https://travis-ci.org/Rochet2/SyphrenaCore.svg?branch=transmogvendor_3.3.5)](https://travis-ci.org/Rochet2/SyphrenaCore)
...
Made for 3.3.5a.<br />
Source: http://www.syphrenacore.org/f/topic/7993-transmogrification-display-vendor/
...
Available as:
- Direct merge: https://github.com/Rochet2/SyphrenaCore/tree/transmogvendor_3.3.5
- Diff: https://github.com/Rochet2/SyphrenaCore/compare/SyphrenaCore:3.3.5...transmogvendor_3.3.5.diff
- Diff in github view: https://github.com/Rochet2/SyphrenaCore/compare/SyphrenaCore:3.3.5...transmogvendor_3.3.5
