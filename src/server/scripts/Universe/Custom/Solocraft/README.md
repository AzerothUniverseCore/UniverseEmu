...
These are my extensions to the [SyphrenaCore][4] WoW Server Emulator for WoW
...
[4]: <https://syphrenacore.atlassian.net/wiki/>

Installation
------------

While following the [SyphrenaCore installation guide][1] after you have used git
to grab the SyphrenaCore source but before you [run cmake][2] you need to add
this git submodule:
...
[3]: <https://github.com/SyphrenaCore/SyphrenaCore/blob/3.3.5/src/server/scripts/Custom/custom_script_loader.cpp>
...
[1]: <https://syphrenacore.atlassian.net/wiki/display/tc/Core+Installation>

[2]: <https://syphrenacore.atlassian.net/wiki/display/tc/Linux+Core+Installation#LinuxCoreInstallation-Configuringforcompiling>
