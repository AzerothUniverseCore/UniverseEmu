...
#define GTS session->GetSyphrenaString
    ...
    public:
        ...
        static bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (sTransmogrification->EnableTransmogInfo)
                AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tFonctionnement Transmogrification", EQUIPMENT_SLOT_END + 9, 0);
            ...
            if (sTransmogrification->EnableSets)
                AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/RAIDFRAME/UI-RAIDFRAME-MAINASSIST:30:30:-18:0|tGerer les ensembles", EQUIPMENT_SLOT_END + 4, 0);
#endif
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|tSupprimer Transmogrifications", EQUIPMENT_SLOT_END + 2, 0, "Supprimer les transmogrifications de tous les objets equipes ?", 0, false);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|tMettre a jour le menu", EQUIPMENT_SLOT_END + 1, 0);
                ...
                case EQUIPMENT_SLOT_END + 4: // Presets menu
                    {
                        ...
                        if (sTransmogrification->EnableSetInfo)
                            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tFonctionnement des ensembles", EQUIPMENT_SLOT_END + 10, 0);
                        ...
                        if (!player->presetMap.empty())
                        {
                            ...
                            if (player->presetMap.size() < sTransmogrification->MaxSets)
                                AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|tEnregistrer l'ensemble", EQUIPMENT_SLOT_END + 8, 0);
                        }
                        else
                            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|tEnregistrer l'ensemble", EQUIPMENT_SLOT_END + 8, 0);
                ...
                case EQUIPMENT_SLOT_END + 6: // view preset
                    {
                        ...
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Statue_02:30:30:-18:0|tUse set", EQUIPMENT_SLOT_END + 5, action, "L’utilisation de cet ensemble pour la transmogrification liera les objets transmogrifiés à vous et les rendra non remboursables et non échangeables.\nSouhaitez-vous continuer ?\n\n" + it->second.name, 0, false);
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-LeaveItem-Opaque:30:30:-18:0|tSupprimer l’ensemble", EQUIPMENT_SLOT_END + 7, action, "Etes-vous sur de vouloir supprimer ? " + it->second.name + "?", 0, false);
                ...
                case EQUIPMENT_SLOT_END + 8: // Save preset
                    {
                        ...
                        if (canSave)
                            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|tEnregistrer l’ensemble", 0, 0, "Entrez le nom de l’ensemble", cost*sTransmogrification->SetCostModifier + sTransmogrification->SetCopperCost, true);
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|tMettre a jour le menu", sender, action);
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tRetour..", EQUIPMENT_SLOT_END + 4, 0);
                        SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                    } break;
                ...
                default: // Transmogrify
                    {
                        ...
                        TransmogSyphrenaStrings res = sTransmogrification->Transmogrify(player, ObjectGuid(HighGuid::Item, 0, action), sender);
                ...
                for (uint8 i = INVENTORY_SLOT_BAG_START; i < INVENTORY_SLOT_BAG_END; ++i)
                {
                    ...
                    for (uint32 j = 0; j < bag->GetBagSize(); ++j)
                    {
                        ...
                        if (oldItem->transmog == newItem->GetEntry())
                            continue;
                        ++limit;
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, sTransmogrification->GetItemIcon(newItem->GetEntry(), 30, 30, -18, 0) + sTransmogrification->GetItemLink(newItem, session), slot, newItem->GetGUID().GetCounter(), "L’utilisation de cet objet pour la transmogrification le liera à vous et le rendra non remboursable et non échangeable.\nSouhaitez-vous continuer??\n\n" + sTransmogrification->GetItemIcon(newItem->GetEntry(), 40, 40, -15, -10) + sTransmogrification->GetItemLink(newItem, session) + ss.str(), price, false);
                    }
                }
            }

            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|tSupprimer la transmogrification", EQUIPMENT_SLOT_END + 3, slot, "Supprimer la transmogrification de cet emplacement ?", 0, false);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|tMettre a jour le menu", EQUIPMENT_SLOT_END, slot);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tRetour..", EQUIPMENT_SLOT_END + 1, 0);
            SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
        }
    };
