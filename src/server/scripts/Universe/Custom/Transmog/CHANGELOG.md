...
- https://github.com/Rochet2/SyphrenaCore/tree/transmog
...
#### 3.7
- Quick update to the patch for latest syphrenacore version

#### 3.6
- Updated the code to work with the new syphrenacore changes
...
- Cleaned all the code I could find to SyphrenaCore standards .. I think
