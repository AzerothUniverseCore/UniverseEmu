# Transmogrification [![Build Status](https://travis-ci.org/Rochet2/SyphrenaCore.svg?branch=transmog_3.3.5)](https://travis-ci.org/Rochet2/SyphrenaCore)
...
Available as:
- Direct merge: https://github.com/Rochet2/SyphrenaCore/tree/transmog_3.3.5
- Diff: https://github.com/Rochet2/SyphrenaCore/compare/SyphrenaCore:3.3.5...transmog_3.3.5.diff
- Diff in github view: https://github.com/Rochet2/SyphrenaCore/compare/SyphrenaCore:3.3.5...transmog_3.3.5

Using direct merge:
- open git bash to source location
- do `git remote add rochet2 https://github.com/Rochet2/SyphrenaCore.git`
...
After compiling:
- SyphrenaCore auto updater should run needed SQLs automatically.
...
#### Changelog: [Changelog](https://github.com/Rochet2/SyphrenaCore/blob/transmog_3.3.5/src/server/scripts/Custom/Transmog/CHANGELOG.md)
