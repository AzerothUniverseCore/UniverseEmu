# TemplateNPC
Template NPC for SyphrenaCore 3.3.5  (Updated 10-March-2019)  


## How to install  
**1.** Navigate to your **SyphrenaCore\src\server\scripts\Custom** and make a new folder called **TemplateNPC**.  
...
**5.** Open SyphrenaCore.sln and Build the solution. Click on **Build** and then **Build Solution** or press (Ctrl+Shift+B)<br/>
