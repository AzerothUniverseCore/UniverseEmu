...
class spell_q11010_q11102_q11023_choose_loc : public SpellScript
{
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        Syphrena::AnyPlayerInObjectRangeCheck checker(caster, 65.0f);
        Syphrena::PlayerListSearcher<Syphrena::AnyPlayerInObjectRangeCheck> searcher(caster, playerList, checker);
