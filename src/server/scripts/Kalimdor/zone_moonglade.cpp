...
public:
    ...
    public:
        ...
        void IsSummonedBy(WorldObject* /*summoner*/) override
        {
            ...
            Syphrena::AnyPlayerInObjectRangeCheck checker(me, 5.0f);
            Syphrena::PlayerListSearcher<Syphrena::AnyPlayerInObjectRangeCheck> searcher(me, playerOnQuestList, checker);
