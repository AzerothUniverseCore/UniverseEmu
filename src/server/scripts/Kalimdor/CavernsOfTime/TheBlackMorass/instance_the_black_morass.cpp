...
public:
    ...
    struct instance_the_black_morass_InstanceMapScript : public InstanceScript
    {
        ...
        void SetData(uint32 type, uint32 data) override
        {
            ...
            case TYPE_MEDIVH:
                ...
                else
                {
                    if (data == IN_PROGRESS)
                    {
                        SC_LOG_DEBUG("scripts", "Instance The Black Morass: Starting event.");
                        InitWorldState();
                    ...
                    if (data == DONE)
                    {
                        ...
                        SC_LOG_DEBUG("scripts", "Instance The Black Morass: Event completed.");
        ...
        Creature* SummonedPortalBoss(Creature* me)
        {
            ...
            SC_LOG_DEBUG("scripts", "Instance The Black Morass: Summoning rift boss entry {}.", entry);
            ...
            SC_LOG_DEBUG("scripts", "Instance The Black Morass: What just happened there? No boss, no loot, no fun...");
            return nullptr;
        }
        ...
        void DoSpawnPortal()
        {
            if (Creature* medivh = instance->GetCreature(_medivhGUID))
            {
                ...
                SC_LOG_DEBUG("scripts", "Instance The Black Morass: Creating Time Rift at locationId {} (old locationId was {}).", tmp, _currentRiftId);
