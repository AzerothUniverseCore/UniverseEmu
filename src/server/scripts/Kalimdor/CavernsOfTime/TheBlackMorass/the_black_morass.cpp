...
struct npc_time_rift : public ScriptedAI
{
    ...
    void DoSelectSummon()
    {
        ...
        SC_LOG_DEBUG("scripts", "npc_time_rift: summoning wave Creature (Wave {}, Entry {}).", mRiftWaveCount, entry);
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        SC_LOG_DEBUG("scripts", "npc_time_rift: not casting anylonger, i need to die.");
