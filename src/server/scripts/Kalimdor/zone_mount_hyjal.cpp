/*
* This file is part of the SyphrenaCoreCore Project. See AUTHORS file for Copyright information
*
        ...
        while (uint32 eventId = _events.ExecuteEvent())
        {
            switch (eventId)
            {
                case EVENT_SUMMON_EMERALD_FLAMES:
                    ...
                    me->GetMotionMaster()->MoveSmoothPath(POINT_NONE, EmeraldFlameweaverPath2, 6, false);
