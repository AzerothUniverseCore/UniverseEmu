    ...
    struct npc_overlord_runthak_orgrimmarAI : public ScriptedAI
    {
        ...
        void GetCitizenGuids()
        {
            ...
            if (gryshkaGUID.IsEmpty())
            {
                ...
                Syphrena::AnyFriendlyUnitInObjectRangeCheck checker(me, me, 25.0f);
                Syphrena::UnitListSearcher<Syphrena::AnyFriendlyUnitInObjectRangeCheck> searcher(me, citizenList, checker);
