...
/* ScriptData
SDName: Boss_Darkweaver_Syth_Skyreach
SD%Complete: 85
...
enum Spells
{
    SPELL_FROST_SHOCK           = 2021401, //37865
    SPELL_FLAME_SHOCK           = 2034354,
    SPELL_SHADOW_SHOCK          = 2030138,
    SPELL_ARCANE_SHOCK          = 2037132,

    SPELL_CHAIN_LIGHTNING       = 2015659, //15305

    SPELL_SUMMON_SYTH_FIRE      = 2033537,                   // Spawns 19203
    SPELL_SUMMON_SYTH_ARCANE    = 2033538,                   // Spawns 19205
    SPELL_SUMMON_SYTH_FROST     = 2033539,                   // Spawns 19204
    SPELL_SUMMON_SYTH_SHADOW    = 2033540,                   // Spawns 19206

    SPELL_FLAME_BUFFET          = 2033526,
    SPELL_ARCANE_BUFFET         = 2033527,
    SPELL_FROST_BUFFET          = 2033528,
    SPELL_SHADOW_BUFFET         = 2033529
};
...
static constexpr uint32 SPAWN_GROUP_ID_DARKWEAVER_SYTH_MINIONS = 328;

struct boss_darkweaver_syth_skyreach : public BossAI
{
    boss_darkweaver_syth_skyreach(Creature* creature) : BossAI(creature, DATA_DARKWEAVER_SYTH)
    {
        Initialize();
    }
    ...
    void JustAppeared() override
    {
        ...
        instance->instance->SpawnGroupSpawn(SPAWN_GROUP_ID_DARKWEAVER_SYTH_MINIONS, true);
    }

    void EnterEvadeMode(EvadeReason /*why*/) override
    {
        _DespawnAtEvade();
        instance->instance->SpawnGroupDespawn(SPAWN_GROUP_ID_DARKWEAVER_SYTH_MINIONS, true);
    }
...
{
    RegisterSkyreachCreatureAI(boss_darkweaver_syth_skyreach);
}
