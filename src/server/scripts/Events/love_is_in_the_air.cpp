...
class spell_love_is_in_the_air_romantic_picnic : public AuraScript
{
    ...
    void OnPeriodic(AuraEffect const* /*aurEff*/)
    {
        ...
        Syphrena::AnyPlayerInObjectRangeCheck checker(target, INTERACTION_DISTANCE*2);
        Syphrena::PlayerListSearcher<Syphrena::AnyPlayerInObjectRangeCheck> searcher(target, playerList, checker);
...
class spell_love_is_in_the_air_create_heart_candy : public SpellScript
{
    ...
    {
        GetCaster()->CastSpell(GetCaster(), Syphrena::Containers::SelectRandomContainerElement(CreateHeartCandySpells));
    }
