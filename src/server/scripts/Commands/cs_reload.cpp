...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
            ...
            { "item_templateall",              rbac::RBAC_PERM_COMMAND_RELOAD_ITEM_TEMPLATEALL,                 true,  &HandleReloadItemTemplateAllCommand,            "" },
            { "creature_templateall",          rbac::RBAC_PERM_COMMAND_RELOAD_CREATURE_TEMPLATEALL,             true,  &HandleReloadCreatureTemplateAllCommand,        "" },
            { "gameobject_templateall",        rbac::RBAC_PERM_COMMAND_RELOAD_GAMEOBJECT_TEMPLATEALL,           true,  &HandleReloadGameobjectsAllCommand,             "" },
            ...
            { "syphrena_string",               rbac::RBAC_PERM_COMMAND_RELOAD_SYPHRENA_STRING,                  true,  &HandleReloadSyphrenaStringCommand,             "" },
    ...
    static bool HandleReloadItemTemplateAllCommand(ChatHandler* handler, const char*)
    {
        sObjectMgr->LoadItemTemplates();
        handler->SendGlobalGMSysMessage("DB table `item_template` recharger.");
        return true;
    }

    static bool HandleReloadCreatureTemplateAllCommand(ChatHandler* handler, const char*)
    {
        sObjectMgr->LoadCreatureTemplates();
        handler->SendGlobalGMSysMessage("DB table `creature_template` recharger.");
        return true;
    }


    static bool HandleReloadGameobjectsAllCommand(ChatHandler* handler, const char*)
    {
        sObjectMgr->LoadGameObjectTemplate();
        handler->SendGlobalGMSysMessage("DB table `gameobject_template` recharger.");
        return true;
    }
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        HandleReloadSyphrenaStringCommand(handler, "");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables...");
        LoadLootTables();
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        SC_LOG_INFO("misc", "Re-Loading Quests Relations...");
    ...
    static bool HandleReloadAllScriptsCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        SC_LOG_INFO("misc", "Re-Loading Scripts...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Access Requirement definitions...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Additional Achievement Criteria Data...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Achievement Reward Data...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Tavern Area Triggers...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Area Trigger Teleports definitions...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Autobroadcasts...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Battleground Templates...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Broadcast texts...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading creature award reputation definitions...");
    ...
    {
        SC_LOG_INFO("misc", "Reloading creature summon groups...");
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, char const* args)
    {
        ...
        for (std::string_view entryStr : Syphrena::Tokenize(args, ' ', false))
        {
            uint32 entry = Syphrena::StringTo<uint32>(entryStr).value_or(0);
            ...
            SC_LOG_INFO("misc", "Reloading creature template entry {}", entry);
    ...
    {
        SC_LOG_INFO("misc", "Loading Quests Relations... (`creature_queststarter`)");
    ...
    {
        SC_LOG_INFO("misc", "Loading Linked Respawns... (`creature_linked_respawn`)");
    ...
    {
        SC_LOG_INFO("misc", "Loading Quests Relations... (`creature_questender`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading `gossip_menu` Table!");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading `gossip_menu_option` Table!");
    ...
    {
        SC_LOG_INFO("misc", "Loading Quests Relations... (`gameobject_queststarter`)");
    ...
    {
        SC_LOG_INFO("misc", "Loading Quests Relations... (`gameobject_questender`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Quest Area Triggers...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Quest Greeting ...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Quest Greeting locales...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Quest Templates...");
        sObjectMgr->LoadQuests();
        sObjectMgr->InitializeQueriesData(QUERY_DATA_QUESTS);
        handler->SendGlobalGMSysMessage("DB table `quest_template` (quest definitions) reloaded.");

        /// dependent also from `gameobject` but this table not reloaded anyway
        SC_LOG_INFO("misc", "Re-Loading GameObjects for quests...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`creature_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Creature movement overrides...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`disenchant_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`fishing_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`gameobject_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`item_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`milling_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`pickpocketing_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`prospecting_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`mail_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`reference_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`skinning_loot_template`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Loot Tables... (`spell_loot_template`)");
    ...
    static bool HandleReloadSyphrenaStringCommand(ChatHandler* handler, char const* /*args*/)
    {
        SC_LOG_INFO("misc", "Re-Loading syphrena_string Table!");
        sObjectMgr->LoadSyphrenaStrings();
        handler->SendGlobalGMSysMessage("DB table `syphrena_string` reloaded.");
        return true;
    }

    static bool HandleReloadTrainerCommand(ChatHandler* handler, char const* /*args*/)
    {
        SC_LOG_INFO("misc", "Re-Loading `trainer` Table!");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading `npc_vendor` Table!");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading `points_of_interest` Table!");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Quest POI ..." );
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading `npc_spellclick_spells` Table!");
    ...
    {
        SC_LOG_INFO("misc", "Loading ReservedNames... (`reserved_name`)");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading `reputation_reward_rate` Table!" );
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading `reputation_spillover_template` Table!" );
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Skill Discovery Table...");
    ...
    { // latched onto HandleReloadSkillExtraItemTemplateCommand as it's part of that table group (and i don't want to chance all the command IDs)
        SC_LOG_INFO("misc", "Re-Loading Skill Perfection Data Table...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Skill Extra Item Table...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Skill Fishing base level requirements...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading SpellArea Data...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell Required Data... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell Groups...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell Learn Spells...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell Linked Spells...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell Proc conditions and data...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell Bonus Data...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell target coordinates...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Aggro Spells Definitions...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell Group Stack Rules...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Spell pet auras...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Page Text...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Item Random Enchantments Table...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Item set names...");
    ...
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (*args != 'a')
            SC_LOG_INFO("misc", "Re-Loading Scripts from `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (*args != 'a')
            SC_LOG_INFO("misc", "Re-Loading Scripts from `waypoint_scripts`...");
    ...
    {
        if (*args != 'a')
            SC_LOG_INFO("misc", "Re-Loading Waypoints data from 'waypoints_data'");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (*args != 'a')
            SC_LOG_INFO("misc", "Re-Loading Scripts from `spell_scripts`...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Graveyard-zone links...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Game Tele coordinates...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading disables table...");
        DisableMgr::LoadDisables();
        SC_LOG_INFO("misc", "Checking quest disables...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Achievement Reward Data Locale...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading lfg dungeon rewards...");
        sLFGMgr->LoadRewards();
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Creature Template Locale...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Creature Texts Locale...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Gameobject Template Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Gossip Menu Option Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Item Template Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Item set name Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading NPC Text Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Page Text Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Points Of Interest Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Quest Template Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Quest Offer Reward Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Quest Request Item Locale... ");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Player level dependent mail rewards...");
    ...
    static bool HandleReloadAuctionsCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        SC_LOG_INFO("misc", "Re-Loading Auctions...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Conditions...");
        sConditionMgr->LoadConditions(true);
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Creature Texts...");
    ...
    {
        SC_LOG_INFO("misc", "Re-Loading Smart Scripts...");
    ...
    {
        SC_LOG_INFO("misc", "Reloading vehicle_template table...");
    ...
    {
        SC_LOG_INFO("misc", "Reloading vehicle_accessory table...");
    ...
    {
        SC_LOG_INFO("misc", "Reloading vehicle_template_accessory table...");
    ...
    {
        SC_LOG_INFO("misc", "Reloading RBAC tables...");
