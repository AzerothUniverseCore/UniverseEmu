...
public:
    ...
    static bool HandleMmapTestArea(ChatHandler* handler, char const* /*args*/)
    {
        ...
        Syphrena::AnyUnitInObjectRangeCheck go_check(object, radius);
        Syphrena::CreatureListSearcher<Syphrena::AnyUnitInObjectRangeCheck> go_search(object, creatureList, go_check);
