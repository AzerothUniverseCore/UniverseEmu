...
public:
    ...
    */
    ...
    static bool HandleWpEventCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (show == "add")
        {
            if (Optional<uint32> id = Syphrena::StringTo<uint32>(arg_id))
            {
        ...
        if (show == "listid")
        {
            ...
            uint32 id = Syphrena::StringTo<uint32>(arg_id).value_or(0);
        ...
        if (show == "mod")
        {
            ...
            if (arg_str_2 == "setid")
            {
                uint32 newid = Syphrena::StringTo<uint32>(arg_3).value_or(0);
    ...
    static bool HandleWpShowCommand(ChatHandler* handler, char const* args)
    {
        ...
        else
        {
            ...
            pathid = Syphrena::StringTo<uint32>(guid_str).value_or(0);
        }
