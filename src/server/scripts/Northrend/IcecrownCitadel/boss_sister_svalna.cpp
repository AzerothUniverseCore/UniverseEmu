...
struct npc_crok_scourgebane : public EscortAI
{
    ...
    void WaypointStarted(uint32 waypointId, uint32 /*pathId*/) override
    {
        ...
        switch (waypointId)
        {
            ...
            case 4:
            {
                ...
                Syphrena::CreatureListSearcher<FrostwingVrykulSearcher> searcher(me, temp, check);
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
    {
        ...
        if (!_wipeCheckTimer)
        {
            ...
            Syphrena::AnyPlayerInObjectRangeCheck check(me, 60.0f);
            Syphrena::PlayerSearcher<Syphrena::AnyPlayerInObjectRangeCheck> searcher(me, player, check);
            ...
            if (!player)
            {
                ...
                if (damage >= me->GetHealth())
                {
                    ...
                    Syphrena::CreatureWorker<FrostwingGauntletRespawner> worker(me, respawner);
        ...
        while (uint32 eventId = Events.ExecuteEvent())
        {
            switch (eventId)
            {
                ...
                case EVENT_ARNATH_PW_SHIELD:
                {
                    ...
                    if (!targets.empty())
                        DoCast(Syphrena::Containers::SelectRandomContainerElement(targets), SPELL_POWER_WORD_SHIELD);
...
private:
    Creature* FindFriendlyCreature() const
    {
        ...
        Syphrena::MostHPMissingInRange u_check(me, 60.0f, 0);
        Syphrena::CreatureLastSearcher<Syphrena::MostHPMissingInRange> searcher(me, target, u_check);
...
class spell_svalna_revive_champion : public SpellScript
{
    ...
    void RemoveAliveTarget(std::list<WorldObject*>& targets)
    {
        ...
        Syphrena::Containers::RandomResize(targets, 2);
    }
