    ...
    public:
                ...
                case DATA_HORSEMEN_IS_TIMED_KILL:
                {
                    ...
                    for (Horseman boss : horsemen)
                        if (Creature* cBoss = getHorsemanHandle(boss))
                        {
                            ...
                            if (!deathTime)
                            {
                                SC_LOG_WARN("scripts", "FourHorsemenAI: Checking for achievement credit but horseman {} is reporting not dead", cBoss->GetName());
                                return 0;
                            }
                        ...
                        {
                            SC_LOG_WARN("scripts", "FourHorsemenAI: Checking for achievement credit but horseman with id {} is not present", uint32(boss));
                            return 0;
                        }
        ...
        void CheckIsMovementFinished()
        {
            for (Horseman boss : horsemen)
            {
                ...
                {
                    SC_LOG_WARN("scripts", "FourHorsemenAI: Checking if movement is finished but horseman with id {} is not present", uint32(boss));
                    ResetEncounter();
                    return;
                }
            }
        ...
        void BeginEncounter()
        {
            ...
            for (Horseman boss : horsemen)
            {
                ...
                {
                    SC_LOG_WARN("scripts", "FourHorsemenAI: Encounter starting but horseman with id {} is not present", uint32(boss));
                    ResetEncounter();
                    return;
                }
            }
        ...
        void ResetEncounter()
        {
            ...
            for (Horseman boss : horsemen)
            {
                if (Creature* cBoss = getHorsemanHandle(boss))
                    ...
                    SC_LOG_WARN("scripts", "FourHorsemenAI: Encounter resetting but horseman with id {} is not present", uint32(boss));
            }
        }
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            for (Horseman boss : horsemen)
            {
                ...
                {
                    SC_LOG_WARN("scripts", "FourHorsemenAI: {} died but horseman with id {} is not present", me->GetName(), uint32(boss));
                    ResetEncounter();
                }
            }
