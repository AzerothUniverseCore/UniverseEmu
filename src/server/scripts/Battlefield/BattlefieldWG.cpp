...
void BattlefieldWG::OnBattleStart()
{
    ...
    if (GameObject* relic = SpawnGameObject(GO_WINTERGRASP_TITAN_S_RELIC, WintergraspRelicPos, WintergraspRelicRot))
    {
        ...
        SC_LOG_ERROR("bg.battlefield", "WG: Failed to spawn titan relic.");
...
uint8 BattlefieldWG::GetSpiritGraveyardId(uint32 areaId) const
{
    switch (areaId)
    {
        ...
        default:
            SC_LOG_ERROR("bg.battlefield", "BattlefieldWG::GetSpiritGraveyardId: Unexpected Area Id {}", areaId);
            break;
    }
    ...
    switch (_type)
    {
        ...
        case BATTLEFIELD_WG_OBJECTTYPE_DOOR_LAST:
            ...
            if (_wg->GetRelic())
                ...
                SC_LOG_ERROR("bg.battlefield.wg", "Titan Relic not found.");
            break;
        default:
            break;
    }
