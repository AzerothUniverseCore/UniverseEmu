...
class spell_th_grab_targeting : public SpellScript
{
    ...
    {
        (&spell_th_grab_targeting::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        (&spell_th_grab_targeting::HandleDummyEffect, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_th_charge : public SpellScript
{
    void SetDest(SpellDestination& dest)
    {
        ...
        dest.Relocate(Syphrena::Containers::SelectRandomContainerElement(ChargeDestinations));
    }

    void Register() override
    {
        (&spell_th_charge::SetDest, EFFECT_0, TARGET_DEST_NEARBY_ENTRY);
    }
};
...
class spell_th_brawler_explosion : public SpellScript
{
    ...
    void Register() override
    {
        (&spell_th_brawler_explosion::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_th_poison : public AuraScript
{
    ...
    void Register() override
    {
        (&spell_th_poison::HandlePeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
}
