...
public:
    ...
    struct instance_blackrock_depths_InstanceMapScript : public InstanceScript
    {
        ...
        {
            SC_LOG_DEBUG("scripts", "Instance Blackrock Depths: SetGuidData update (Type: {} Data {})", type, data.ToString());
        ...
        {
            SC_LOG_DEBUG("scripts", "Instance Blackrock Depths: SetData update (Type: {} Data {})", type, data);
