...
enum Spells
{
    ...
    SPELL_BLOODMAGE             = 23418,     // syphon blessing
    SPELL_KNIGHT                = 49576,     // Death Grip
    SPELL_DEMON_HUNTER          = 23414,     // Paralise
    SPELL_MONK                  = 23414,     // Paralise
    SPELL_TAMER                 = 23427      // infernals
                ...
                case EVENT_CLASSCALL:
                        ...
                        switch (target->GetClass())
                    {
                        ...
                        case CLASS_BLOODMAGE:
                            Talk(SAY_BLOODMAGE);
                            DoCast(me, SPELL_BLOODMAGE);
                            break;
                        case CLASS_KNIGHT:
                            Talk(SAY_KNIGHT);
                            DoCast(me, SPELL_KNIGHT);
                            break;
