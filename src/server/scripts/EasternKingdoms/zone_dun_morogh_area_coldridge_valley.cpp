            ...
            while (uint32 eventId = _events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_START_PATH:
                        me->GetMotionMaster()->MoveSmoothPath(pathSize, kharanosPath, pathSize, false);
...
public:
    ...
    class spell_a_trip_to_ironforge_quest_complete_SpellScript : public SpellScript
    {
        ...
        {
            (&spell_a_trip_to_ironforge_quest_complete_SpellScript::HandleForceCast, EFFECT_0, SPELL_EFFECT_FORCE_CAST);
        }
    };
...
public:
    ...
    class spell_follow_that_gyrocopter_quest_start_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            (&spell_follow_that_gyrocopter_quest_start_SpellScript::HandleForceCast, EFFECT_1, SPELL_EFFECT_FORCE_CAST);
        }
    };
...
public:
    ...
    class spell_low_health_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            (&spell_low_health_SpellScript::HandleDummyEffect, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
        }
    };
