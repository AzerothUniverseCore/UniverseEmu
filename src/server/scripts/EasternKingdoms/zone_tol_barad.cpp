...
public:
    ...
    class spell_siege_cannon_SpellScript : public SpellScript
    {
        ...
        {
            (&spell_siege_cannon_SpellScript::SelectRandomTarget, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
        }
    };
...
class spell_tb_scrap_master_summon : public SpellScript
{
    ...
    void Register() override
    {
        (&spell_tb_scrap_master_summon::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
