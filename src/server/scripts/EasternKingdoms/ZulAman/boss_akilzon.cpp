        ...
        struct boss_akilzonAI : public BossAI
        {
            ...
            void HandleStormSequence(Unit* Cloud) // 1: begin, 2-9: tick, 10: end
            {
                if (StormCount < 10 && StormCount > 1)
                {
                    ...
                    Syphrena::AnyAoETargetUnitInObjectRangeCheck u_check(me, me, SIZE_OF_GRIDS);
                    Syphrena::UnitListSearcher<Syphrena::AnyAoETargetUnitInObjectRangeCheck> searcher(me, tempUnitMap, u_check);
