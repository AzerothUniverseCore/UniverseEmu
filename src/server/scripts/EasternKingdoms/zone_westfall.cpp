...
class spell_westfall_unbound_energy : public SpellScript
{
    ...
    {
        (&spell_westfall_unbound_energy::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
    }
};
...
class spell_westfall_reaping_blows : public AuraScript
{
    ...
    void Register() override
    {
        (&spell_westfall_reaping_blows::HandlePeriodic, EFFECT_1, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
...
class spell_westfall_wake_harvest_golem : public SpellScript
{
    ...
    void Register() override
    {
        (&spell_westfall_wake_harvest_golem::CheckTarget);
        (&spell_westfall_wake_harvest_golem::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_westfall_quest_credit_jangolode_event : public SpellScript
{
    ...
    void Register() override
    {
        (&spell_westfall_quest_credit_jangolode_event::HandleScriptEffect, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_westfall_summon_ragamuffin_looter : public SpellScript
{
    ...
    void Register() override
    {
        (&spell_westfall_summon_ragamuffin_looter::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_westfall_aggro_hobo : public SpellScript
{
    ...
    void Register() override
    {
        (&spell_westfall_aggro_hobo::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_westfall_sniper_fire_proc : public AuraScript
{
    ...
    void Register() override
    {
        (&spell_westfall_sniper_fire_proc::CheckProc);
        (&spell_westfall_sniper_fire_proc::HandleProc, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL);
    }
...
class spell_westfall_sniper_fire : public SpellScript
{
    ...
    void Register() override
    {
        (&spell_westfall_sniper_fire::HandleDummyEffect, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
}
