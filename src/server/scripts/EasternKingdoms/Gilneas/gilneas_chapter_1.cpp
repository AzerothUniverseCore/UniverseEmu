...
enum GreymanesHorse
{
    ...
    EVENT_START_PATH_2      = 2,
    EVENT_JUMP_TO_KRENNAN   = 3,
    EVENT_ANNOUNCE_RESCUE   = 4,
    EVENT_DISMOUNT_PLAYER   = 5,
        ...
        while (uint32 eventId = _events.ExecuteEvent())
        {
            switch (eventId)
            {
                case EVENT_START_PATH_1:
                    ...
                    me->GetMotionMaster()->MoveSmoothPath(pathSize1, greymanesHorsePath1, pathSize1, PATH_KRENNAN_TREE);
                    break;
                ...
                case EVENT_START_PATH_2:
                    ...
                    me->GetMotionMaster()->MoveSmoothPath(pathSize2, greymanesHorsePath2, pathSize2, PATH_KRENNAN_BACK);
                    break;
...
enum CrowleysHorse
{
    ...
    EVENT_JUMP_OVER_BARRICADES_2 = 2,
    EVENT_MOVE_PATH_MAIN_1       = 3,
    EVENT_MOVE_PATH_MAIN_2       = 4,
