...
#cmakedefine SYPHRENA_IS_DYNAMIC_SCRIPTLOADER

#include "Define.h"
#include <vector>
#include <string>

@SYPHRENA_SCRIPTS_FORWARD_DECL@
#ifdef SYPHRENA_IS_DYNAMIC_SCRIPTLOADER
#  include "revision_data.h"
#  define SC_SCRIPT_API SC_API_EXPORT
extern "C" {

/// Exposed in script modules to return the script module revision hash.
SC_SCRIPT_API char const* GetScriptModuleRevisionHash()
{
    return _HASH;
}
...
SC_SCRIPT_API char const* GetScriptModule()
{
    return "@SYPHRENA_CURRENT_SCRIPT_PROJECT@";
}

#else
#  include "ScriptLoader.h"
#  define SC_SCRIPT_API
#endif

/// Exposed in script modules to register all scripts to the ScriptMgr.
SC_SCRIPT_API void AddScripts()
{
@SYPHRENA_SCRIPTS_INVOKE@}

/// Exposed in script modules to get the build directive of the module.
SC_SCRIPT_API char const* GetBuildDirective()
{
