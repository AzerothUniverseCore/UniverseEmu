...
public:
    ...
    struct npc_commander_dawnforgeAI : public ScriptedAI
    {
        ...
        bool CanStartEvent(Player* player)
        {
            ...
            SC_LOG_DEBUG("scripts", "npc_commander_dawnforge event already in progress, need to wait.");
            return false;
        }
    ...
    struct npc_phase_hunterAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (ManaBurnTimer <= diff)
            {
                ...
                {
                    DoCast(Syphrena::Containers::SelectRandomContainerElement(UnitsWithMana), SPELL_MANA_BURN);
