        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                Syphrena::AllWorldObjectsInRange objects(me, searchDistance);
                Syphrena::WorldObjectListSearcher<Syphrena::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
