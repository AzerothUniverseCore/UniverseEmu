...
public:
    ...
    void Initialize(Syphrena::Asio::IoContext& ioContext, uint32 updateInterval);
    void Close();
...
private:
    ...
    std::unique_ptr<Syphrena::Asio::DeadlineTimer> _updateTimer;
    std::unique_ptr<Syphrena::Asio::Resolver> _resolver;
};
