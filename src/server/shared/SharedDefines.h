...
#ifndef SYPHRENA_SHAREDDEFINES_H
#define SYPHRENA_SHAREDDEFINES_H
...
#define CLASSMASK_ALL_PLAYABLE \
    ...
    (1<<(CLASS_HERO-1)) | (1<<(CLASS_EVOKER-1)) | (1<<(CLASS_CHRONOMANCER-1)))
...
enum PlayerSpecializations
{
    ...
    SPEC_BLOODMAGE_BLOODMAGIC = 0,
    SPEC_BLOODMAGE_BLOODSACRIFICE = 1,
    SPEC_BLOODMAGE_BLOODWOUND = 2,
    SPEC_DRUID_BALANCE = 0,
    SPEC_DRUID_FERAL = 1,
    SPEC_DRUID_RESTORATION = 2,
    SPEC_DEMON_HUNTER_DEVASTATION = 0,
    SPEC_DEMON_HUNTER_VENGEANCE = 1,
    SPEC_DEMON_HUNTER_MASTER = 2,
    SPEC_MONK_BREWMASTER = 0,
    SPEC_MONK_MISTWEAVER = 1,
    SPEC_MONK_WINDWALKING = 2,
    SPEC_TAMER_WICKEDNESS = 0,
    SPEC_TAMER_CURSES = 1,
    SPEC_TAMER_MAGICDEATH = 2,
    SPEC_HERO_STRENGTH = 0,
    SPEC_HERO_ADDRESS = 1,
    SPEC_HERO_POWER = 2
};
...
enum SkillType
{
    ...
    SKILL_DEMON_HUNTER             = 789,
    SKILL_DEVASTATION              = 790,
    SKILL_MASTERGLAIVE             = 791,
    SKILL_BREWMASTER               = 792,
    SKILL_MISTWEAVER               = 793,
    SKILL_WINDWALKING              = 794,
    SKILL_WICKEDNESS               = 795,
    SKILL_CURSES                   = 796,
    SKILL_MASTERDEATH              = 797,
    SKILL_BLOODMAGIC               = 798,
    SKILL_BLOODSACRIFICE           = 799,
    SKILL_BLOODWOUND               = 800,
    SKILL_BLOODYBATTLEMAGE         = 801,
    SKILL_VENGEANCE                = 802,
    SKILL_STRENGHT                 = 803,
    SKILL_ADDRESS                  = 804,
    SKILL_VOLUNTARY                = 805,
    SKILL_MONK                     = 806,
    SKILL_RECYCLER                 = 807,
    SKILL_RACIALWORGEN             = 808,
    SKILL_RACIALGOBLIN             = 809,
    SKILL_PET_XUEN                 = 810,
...
constexpr SkillType SkillByLockType(LockType locktype)
{
    switch (locktype)
    {
        ...
        case LOCKTYPE_RECYCLER:    return SKILL_RECYCLER;
        default: break;
    }
    return SKILL_NONE;
}
...
enum TotemCategory
{
    ...
    SC_TRUESILVER_ROD              = 9,
    SC_ARCANITE_ROD                = 10,
    SC_MINING_PICK_OLD             = 11,
    SC_PHILOSOPHERS_STONE          = 12,
    SC_BLACKSMITH_HAMMER_OLD       = 13,
    SC_ARCLIGHT_SPANNER            = 14,
    SC_GYROMATIC_MA                = 15,
    SC_MASTER_TOTEM                = 21,
    SC_FEL_IRON_ROD                = 41,
    SC_ADAMANTITE_ROD              = 62,
    SC_ETERNIUM_ROD                = 63,
    SC_HOLLOW_QUILL                = 81,
    SC_RUNED_AZURITE_ROD           = 101,
    SC_VIRTUOSO_INKING_SET         = 121,
    SC_DRUMS                       = 141,
    SC_GNOMISH_ARMY_KNIFE          = 161,
    SC_BLACKSMITH_HAMMER           = 162,
    SC_MINING_PICK                 = 165,
    SC_SKINNING_KNIFE              = 166,
    SC_HAMMER_PICK                 = 167,
    SC_BLADED_PICKAXE              = 168,
    SC_FLINT_AND_TINDER            = 169,
    SC_RUNED_COBALT_ROD            = 189,
    SC_RUNED_TITANIUM_ROD          = 190
};
...
enum SpellFamilyNames
{
    ...
    SPELLFAMILY_BLOODMAGE           = 18, // TITLE Blood Battle Mage
    SPELLFAMILY_KNIGHT              = 19, // TITLE Knight
    SPELLFAMILY_DEMONHUNTER         = 20, // TITLE Demon Hunter
    SPELLFAMILY_MONK                = 21, // TITLE Monk
    SPELLFAMILY_TAMER               = 22, // TITLE Tamer
    SPELLFAMILY_HERO                = 23, // TITLE Hero
    SPELLFAMILY_EVOKER              = 24, // TITLE Evoker
    SPELLFAMILY_CHRONOMANCER        = 25  // TITLE Chronomancer
};
...
enum BattlegroundQueueTypeId
{
    ...
    BATTLEGROUND_QUEUE_BFG      = 11,
    BATTLEGROUND_QUEUE_TP       = 12,
...
namespace Impl
{
    struct SC_SHARED_API CurrentServerProcessHolder
    {
...
#define THIS_SERVER_PROCESS (Syphrena::Impl::CurrentServerProcessHolder::type())
