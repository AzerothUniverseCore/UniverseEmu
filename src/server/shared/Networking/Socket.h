...
public:
    ...
    void CloseSocket()
    {
        ...
        if (shutdownError)
            SC_LOG_DEBUG("network", "Socket::CloseSocket: {} errored when shutting down socket: {} ({})", GetRemoteIpAddress().to_string(),
...
protected:
    ...
    void SetNoDelay(bool enable)
    {
        ...
        if (err)
            SC_LOG_DEBUG("network", "Socket::SetNoDelay: failed to set_option(boost::asio::ip::tcp::no_delay) for {} - {} ({})",
