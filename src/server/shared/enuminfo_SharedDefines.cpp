...
namespace Syphrena::Impl::EnumUtilsImpl
{
...
\*************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<Races>::ToString(Races value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Races>::Count() { return 31; }

template <>
SC_API_EXPORT Races EnumUtils<Races>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Races>::ToIndex(Races value)
{
    switch (value)
    {
...
\***************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<Classes>::ToString(Classes value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Classes>::Count() { return 23; }

template <>
SC_API_EXPORT Classes EnumUtils<Classes>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Classes>::ToIndex(Classes value)
{
    switch (value)
    {
...
\**************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<Powers>::ToString(Powers value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Powers>::Count() { return 8; }

template <>
SC_API_EXPORT Powers EnumUtils<Powers>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Powers>::ToIndex(Powers value)
{
    switch (value)
    {
...
\********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellSchools>::ToString(SpellSchools value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellSchools>::Count() { return 7; }

template <>
SC_API_EXPORT SpellSchools EnumUtils<SpellSchools>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellSchools>::ToIndex(SpellSchools value)
{
    switch (value)
    {
...
\******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellAttr0>::ToString(SpellAttr0 value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr0>::Count() { return 32; }

template <>
SC_API_EXPORT SpellAttr0 EnumUtils<SpellAttr0>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr0>::ToIndex(SpellAttr0 value)
{
    switch (value)
    {
...
\******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellAttr1>::ToString(SpellAttr1 value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr1>::Count() { return 32; }

template <>
SC_API_EXPORT SpellAttr1 EnumUtils<SpellAttr1>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr1>::ToIndex(SpellAttr1 value)
{
    switch (value)
    {
...
\******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellAttr2>::ToString(SpellAttr2 value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr2>::Count() { return 32; }

template <>
SC_API_EXPORT SpellAttr2 EnumUtils<SpellAttr2>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr2>::ToIndex(SpellAttr2 value)
{
    switch (value)
    {
...
\******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellAttr3>::ToString(SpellAttr3 value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr3>::Count() { return 32; }

template <>
SC_API_EXPORT SpellAttr3 EnumUtils<SpellAttr3>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr3>::ToIndex(SpellAttr3 value)
{
    switch (value)
    {
...
\******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellAttr4>::ToString(SpellAttr4 value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr4>::Count() { return 32; }

template <>
SC_API_EXPORT SpellAttr4 EnumUtils<SpellAttr4>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr4>::ToIndex(SpellAttr4 value)
{
    switch (value)
    {
...
\******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellAttr5>::ToString(SpellAttr5 value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr5>::Count() { return 32; }

template <>
SC_API_EXPORT SpellAttr5 EnumUtils<SpellAttr5>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr5>::ToIndex(SpellAttr5 value)
{
    switch (value)
    {
...
\******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellAttr6>::ToString(SpellAttr6 value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr6>::Count() { return 32; }

template <>
SC_API_EXPORT SpellAttr6 EnumUtils<SpellAttr6>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr6>::ToIndex(SpellAttr6 value)
{
    switch (value)
    {
...
\******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellAttr7>::ToString(SpellAttr7 value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr7>::Count() { return 32; }

template <>
SC_API_EXPORT SpellAttr7 EnumUtils<SpellAttr7>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellAttr7>::ToIndex(SpellAttr7 value)
{
    switch (value)
    {
...
\***********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellCastResult>::ToString(SpellCastResult value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellCastResult>::Count() { return 189; }

template <>
SC_API_EXPORT SpellCastResult EnumUtils<SpellCastResult>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellCastResult>::ToIndex(SpellCastResult value)
{
    switch (value)
    {
...
\*********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<AuraStateType>::ToString(AuraStateType value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<AuraStateType>::Count() { return 18; }

template <>
SC_API_EXPORT AuraStateType EnumUtils<AuraStateType>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<AuraStateType>::ToIndex(AuraStateType value)
{
    switch (value)
    {
...
\*****************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<Mechanics>::ToString(Mechanics value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Mechanics>::Count() { return 32; }

template <>
SC_API_EXPORT Mechanics EnumUtils<Mechanics>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Mechanics>::ToIndex(Mechanics value)
{
    switch (value)
    {
...
\*********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellDmgClass>::ToString(SpellDmgClass value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellDmgClass>::Count() { return 4; }

template <>
SC_API_EXPORT SpellDmgClass EnumUtils<SpellDmgClass>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellDmgClass>::ToIndex(SpellDmgClass value)
{
    switch (value)
    {
...
\***************************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellPreventionType>::ToString(SpellPreventionType value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellPreventionType>::Count() { return 3; }

template <>
SC_API_EXPORT SpellPreventionType EnumUtils<SpellPreventionType>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpellPreventionType>::ToIndex(SpellPreventionType value)
{
    switch (value)
    {
...
\*************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<Emote>::ToString(Emote value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Emote>::Count() { return 174; }

template <>
SC_API_EXPORT Emote EnumUtils<Emote>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<Emote>::ToIndex(Emote value)
{
    switch (value)
    {
...
\*******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<WeatherType>::ToString(WeatherType value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<WeatherType>::Count() { return 6; }

template <>
SC_API_EXPORT WeatherType EnumUtils<WeatherType>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<WeatherType>::ToIndex(WeatherType value)
{
    switch (value)
    {
...
\***************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<ChatMsg>::ToString(ChatMsg value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<ChatMsg>::Count() { return 53; }

template <>
SC_API_EXPORT ChatMsg EnumUtils<ChatMsg>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<ChatMsg>::ToIndex(ChatMsg value)
{
    switch (value)
    {
...
\************************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpellFamilyNames>::ToString(SpellFamilyNames value)
{
    switch (value)
    {
        ...
        case SPELLFAMILY_BLOODMAGE: return { "SPELLFAMILY_BLOODMAGE", "Blood Battle Mage", "" };
        case SPELLFAMILY_KNIGHT: return { "SPELLFAMILY_KNIGHT", "Knight", "" };
        case SPELLFAMILY_DEMONHUNTER: return { "SPELLFAMILY_DEMONHUNTER", "Demon Hunter", "" };
        case SPELLFAMILY_MONK: return { "SPELLFAMILY_MONK", "Monk", "" };
        case SPELLFAMILY_TAMER: return { "SPELLFAMILY_TAMER", "Tamer", "" };
        case SPELLFAMILY_HERO: return { "SPELLFAMILY_HERO", "Hero", "" };
        case SPELLFAMILY_EVOKER: return { "SPELLFAMILY_EVOKER", "Evoker", "" };
        case SPELLFAMILY_CHRONOMANCER: return { "SPELLFAMILY_CHRONOMANCER", "Chronomancer", "" };
        default: throw std::out_of_range("value");
    }
}

template <>
SC_API_EXPORT size_t EnumUtils<SpellFamilyNames>::Count() { return 23; }

template <>
SC_API_EXPORT SpellFamilyNames EnumUtils<SpellFamilyNames>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 15: return SPELLFAMILY_BLOODMAGE;
        case 16: return SPELLFAMILY_KNIGHT;
        case 17: return SPELLFAMILY_DEMONHUNTER;
        case 18: return SPELLFAMILY_MONK;
        case 19: return SPELLFAMILY_TAMER;
        case 20: return SPELLFAMILY_HERO;
        case 21: return SPELLFAMILY_EVOKER;
        case 22: return SPELLFAMILY_CHRONOMANCER;
        default: throw std::out_of_range("index");
    }
}

template <>
SC_API_EXPORT size_t EnumUtils<SpellFamilyNames>::ToIndex(SpellFamilyNames value)
{
    switch (value)
    {
        ...
        case SPELLFAMILY_BLOODMAGE: return 15;
        case SPELLFAMILY_KNIGHT: return 16;
        case SPELLFAMILY_DEMONHUNTER: return 17;
        case SPELLFAMILY_MONK: return 18;
        case SPELLFAMILY_TAMER: return 19;
        case SPELLFAMILY_HERO: return 20;
        case SPELLFAMILY_EVOKER: return 21;
        case SPELLFAMILY_CHRONOMANCER: return 22;
        default: throw std::out_of_range("value");
    }
}
}
