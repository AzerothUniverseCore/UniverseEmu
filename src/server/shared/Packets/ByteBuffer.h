...
class SC_SHARED_API ByteBufferException : public std::exception
{
public:
...
class SC_SHARED_API ByteBufferPositionException : public ByteBufferException
{
public:
...
class SC_SHARED_API ByteBufferSourceException : public ByteBufferException
{
public:
...
class SC_SHARED_API ByteBufferInvalidValueException : public ByteBufferException
{
public:
...
class SC_SHARED_API ByteBuffer
{
    public:
