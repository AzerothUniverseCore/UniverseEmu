...
*/
class SC_GAME_API Battleground
{
    public:
        Battleground();
        ...
        Syphrena::unique_weak_ptr<Battleground> GetWeakPtr() const { return m_weakRef; }
        void SetWeakPtr(Syphrena::unique_weak_ptr<Battleground> weakRef) { m_weakRef = std::move(weakRef); }
    ...
    private:
        ...
        Syphrena::unique_weak_ptr<Battleground> m_weakRef;
};
#endif
