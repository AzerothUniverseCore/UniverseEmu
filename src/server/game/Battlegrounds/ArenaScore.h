...
#ifndef SYPHRENA_ARENA_SCORE_H
#define SYPHRENA_ARENA_SCORE_H

#include "BattlegroundScore.h"
#include <sstream>

struct SC_GAME_API ArenaScore : public BattlegroundScore
{
    friend class Arena;
...
struct SC_GAME_API ArenaTeamScore
{
    friend class Arena;
