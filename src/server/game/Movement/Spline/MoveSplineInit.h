...
#ifndef SYPHRENASERVER_MOVESPLINEINIT_H
#define SYPHRENASERVER_MOVESPLINEINIT_H
...
namespace Movement
{
    ...
    class SC_GAME_API TransportPathTransform
    {
    public:
     ...
     */
    class SC_GAME_API MoveSplineInit
    {
    public:
...
#endif // SYPHRENASERVER_MOVESPLINEINIT_H
