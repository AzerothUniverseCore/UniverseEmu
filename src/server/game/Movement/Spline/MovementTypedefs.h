...
#ifndef SYPHRENASERVER_TYPEDEFS_H
#define SYPHRENASERVER_TYPEDEFS_H
...
namespace Movement
{
    ...
    SC_GAME_API extern float gravity;
    SC_GAME_API extern UInt32Counter splineIdGen;
}

#endif // SYPHRENASERVER_TYPEDEFS_H
