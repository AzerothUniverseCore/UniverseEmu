...
#ifndef SYPHRENA_SPLINECHAINMOVEMENTGENERATOR_H
#define SYPHRENA_SPLINECHAINMOVEMENTGENERATOR_H
...
class SC_GAME_API SplineChainMovementGenerator : public MovementGenerator
{
    public:
