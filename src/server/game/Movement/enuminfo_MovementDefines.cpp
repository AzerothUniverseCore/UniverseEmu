...
\*******************************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<MovementGeneratorType>::ToString(MovementGeneratorType value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<MovementGeneratorType>::Count() { return 19; }

template <>
SC_API_EXPORT MovementGeneratorType EnumUtils<MovementGeneratorType>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<MovementGeneratorType>::ToIndex(MovementGeneratorType value)
{
    switch (value)
    {
