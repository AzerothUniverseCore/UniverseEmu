...
#ifndef SYPHRENA_HYPERLINKS_H
#define SYPHRENA_HYPERLINKS_H
...
namespace Syphrena::Hyperlinks
{
    ...
    namespace LinkTags {
        ...
        struct base_tag
        {
            ...
            {
                if (Optional<T> res = Syphrena::StringTo<T>(data))
                {
                    val = *res;
                    return true;
                }
            ...
            {
                if (Optional<uint64> res = Syphrena::StringTo<uint64>(data, 16))
                {
                    val.Set(*res);
                    return true;
                }
    ...
    #undef make_base_tag
        ...
        struct SC_GAME_API achievement
        {
    ...
    HyperlinkInfo SC_GAME_API ParseSingleHyperlink(std::string_view str);
    bool SC_GAME_API CheckAllLinks(std::string_view str);
