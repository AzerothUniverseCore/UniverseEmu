...
#ifndef SYPHRENACORE_CHAT_H
#define SYPHRENACORE_CHAT_H
...
class SC_GAME_API ChatHandler
{
    public:
        ...
        virtual char const* GetSyphrenaString(uint32 entry) const;
        ...
        {
            return fmt::sprintf(GetSyphrenaString(entry), std::forward<Args>(args)...);
        }
...
class SC_GAME_API CliHandler : public ChatHandler
{
    public:
        ...
        // overwrite functions
        char const* GetSyphrenaString(uint32 entry) const override;
...
class SC_GAME_API AddonChannelCommandHandler : public ChatHandler
{
    public:
