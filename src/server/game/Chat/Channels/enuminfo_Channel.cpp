...
\************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<ChatNotify>::ToString(ChatNotify value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<ChatNotify>::Count() { return 36; }

template <>
SC_API_EXPORT ChatNotify EnumUtils<ChatNotify>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<ChatNotify>::ToIndex(ChatNotify value)
{
    switch (value)
    {
