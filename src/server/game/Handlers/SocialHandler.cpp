...
void WorldSession::HandleAddFriendOpcode(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "WorldSession::HandleAddFriendOpcode: {} asked to add friend: {}",
...
void WorldSession::HandleDelFriendOpcode(WorldPacket& recvData)
{
    ...
    recvData >> friendGuid;
    SC_LOG_DEBUG("network", "WorldSession::HandleDelFriendOpcode: {}", friendGuid.ToString());
...
void WorldSession::HandleAddIgnoreOpcode(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "WorldSession::HandleAddIgnoreOpcode: {} asked to Ignore: {}",
...
void WorldSession::HandleDelIgnoreOpcode(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "WorldSession::HandleDelIgnoreOpcode: {}", ignoreGuid.ToString());
...
void WorldSession::HandleSetContactNotesOpcode(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "WorldSession::HandleSetContactNotesOpcode: Contact: {}, Notes: {}", guid.ToString(), note);
