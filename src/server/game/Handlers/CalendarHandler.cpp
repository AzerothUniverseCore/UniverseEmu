...
void WorldSession::HandleCalendarGetCalendar(WorldPacket& /*recvData*/)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_GET_CALENDAR [{}]", guid.ToString());
...
void WorldSession::HandleCalendarGetEvent(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_GET_EVENT. Player [{}] Event [{}]", _player->GetGUID().ToString(), eventId);
...
{
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_GUILD_FILTER [{}]", _player->GetGUID().ToString());
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_GUILD_FILTER: Min level [{}], Max level [{}], Min rank [{}]", minLevel, maxLevel, minRank);
}

void WorldSession::HandleCalendarArenaTeam(WorldPacket& recvData)
{
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_ARENA_TEAM [{}]", _player->GetGUID().ToString());
...
void WorldSession::HandleCalendarUpdateEvent(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_UPDATE_EVENT [{}] EventId [" UI64FMTD
...
void WorldSession::HandleCalendarCopyEvent(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_COPY_EVENT [{}], EventId [" UI64FMTD
...
{
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_EVENT_INVITE");
...
void WorldSession::HandleCalendarEventSignup(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_EVENT_SIGNUP [{}] EventId [{}] Tentative {}", guid.ToString(), eventId, tentative);
...
void WorldSession::HandleCalendarEventRsvp(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_EVENT_RSVP [{}] EventId ["
...
void WorldSession::HandleCalendarEventRemoveInvite(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_EVENT_REMOVE_INVITE [{}] EventId [" UI64FMTD
...
void WorldSession::HandleCalendarEventStatus(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_EVENT_STATUS [{}] EventId ["
...
void WorldSession::HandleCalendarEventModeratorStatus(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_EVENT_MODERATOR_STATUS [{}] EventId ["
        UI64FMTD "] ownerInviteId [{}], Invitee ([{}] id: ["
...
void WorldSession::HandleCalendarComplain(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_COMPLAIN [{}] EventId ["
...
void WorldSession::HandleCalendarGetNumPending(WorldPacket& /*recvData*/)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_CALENDAR_GET_NUM_PENDING: [{}] Pending: {}", guid.ToString(), pending);
...
void WorldSession::HandleSetSavedInstanceExtend(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("network", "CMSG_SET_SAVED_INSTANCE_EXTEND - MapId: {}, Difficulty: {}, ToggleExtend: {}", mapId, difficulty, toggleExtend ? "On" : "Off");
...
{
    SC_LOG_DEBUG("network", "{}", add ? "SMSG_CALENDAR_RAID_LOCKOUT_ADDED" : "SMSG_CALENDAR_RAID_LOCKOUT_REMOVED");
    time_t currTime = GameTime::GetGameTime();
...
void WorldSession::SendCalendarRaidLockoutUpdated(InstanceSave const* save)
{
    ...
    ObjectGuid guid = _player->GetGUID();
    SC_LOG_DEBUG("network", "SMSG_CALENDAR_RAID_LOCKOUT_UPDATED [{}] Map: {}, Difficulty {}",
