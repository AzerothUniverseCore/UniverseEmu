...
void WorldSession::HandleBfQueueInviteResponse(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("misc", "HandleBfQueueInviteResponse: BattleID:{} Accepted:{}", battleId, accepted);
...
void WorldSession::HandleBfEntryInviteResponse(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("misc", "HandleBfEntryInviteResponse: battleId: {}, accepted: {}", battleId, accepted);
...
void WorldSession::HandleBfQueueExitRequest(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("misc", "HandleBfQueueExitRequest: battleId: {} ", battleId);
