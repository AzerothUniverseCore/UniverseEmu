...
void WorldSession::HandleDuelAcceptedOpcode(WorldPacket& recvPacket)
{
    ...
    //SC_LOG_DEBUG("network", "WORLD: Received CMSG_DUEL_ACCEPTED");
    SC_LOG_DEBUG("network", "Player 1 is: {} ({})", player->GetGUID().ToString(), player->GetName());
    SC_LOG_DEBUG("network", "Player 2 is: {} ({})", target->GetGUID().ToString(), target->GetName());
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_DUEL_CANCELLED");
    Player* player = GetPlayer();
