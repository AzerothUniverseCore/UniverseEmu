...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_INVITE");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_ACCEPT");
    ...
    {
        SC_LOG_ERROR("network", "HandleGroupAcceptOpcode: player {} {} tried to accept an invite to his own group", GetPlayer()->GetName(), GetPlayer()->GetGUID().ToString());
        return;
    }
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_DECLINE");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE_GUID");
    ...
    {
        SC_LOG_ERROR("network", "WorldSession::HandleGroupUninviteGuidOpcode: leader {} {} tried to uninvite himself from the group.",
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE");
    ...
    {
        SC_LOG_ERROR("network", "WorldSession::HandleGroupUninviteOpcode: leader {} {} tried to uninvite himself from the group.",
            GetPlayer()->GetName(), GetPlayer()->GetGUID().ToString());
        return;
    }
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SET_LEADER");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_DISBAND");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_LOOT_METHOD");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received MSG_MINIMAP_PING");
    ...
    //SC_LOG_DEBUG("Received opcode MSG_MINIMAP_PING X: {}, Y: {}", x, y);
...
{
    SC_LOG_DEBUG("network", "WORLD: Received MSG_RAID_TARGET_UPDATE");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_RAID_CONVERT");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_CHANGE_SUB_GROUP");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_ASSISTANT_LEADER");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received MSG_PARTY_ASSIGNMENT");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received MSG_RAID_READY_CHECK");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_REQUEST_PARTY_MEMBER_STATS");
    ObjectGuid Guid;
    recvData >> Guid;
...
{
    SC_LOG_DEBUG("WORLD: got CMSG_GROUP_CANCEL.");
}*/

void WorldSession::HandleOptOutOfLootOpcode(WorldPacket& recvData)
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_OPT_OUT_OF_LOOT");
    ...
    {
        if (passOnLoot != 0)
            SC_LOG_ERROR("network", "CMSG_OPT_OUT_OF_LOOT value<>0 for not-loaded character!");
        return;
    }
