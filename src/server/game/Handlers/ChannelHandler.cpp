...
void WorldSession::HandleJoinChannel(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_JOIN_CHANNEL {} Channel: {}, unk1: {}, unk2: {}, channel: {}, password: {}",
    ...
    {
        SC_LOG_ERROR("network", "Player {} tried to create a channel with a password more than " SZFMTD " characters long - blocked", GetPlayer()->GetGUID().ToString(), MAX_CHANNEL_PASS_STR);
        return;
    }
    ...
    if (ChannelMgr* cMgr = ChannelMgr::forTeam(GetPlayer()->GetTeam()))
    {
        ...
        { // custom channel
            ...
            {
                SC_LOG_ERROR("network", "Player {} tried to create a channel with a name more than " SZFMTD " characters long - blocked", GetPlayer()->GetGUID().ToString(), MAX_CHANNEL_NAME_STR);
                return;
            }
...
void WorldSession::HandleLeaveChannel(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_LEAVE_CHANNEL {} Channel: {}, channelId: {}",
...
void WorldSession::HandleChannelList(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "{} {} Channel: {}",
...
void WorldSession::HandleChannelPassword(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_PASSWORD {} Channel: {}, Password: {}",
...
void WorldSession::HandleChannelSetOwner(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_SET_OWNER {} Channel: {}, Target: {}",
...
void WorldSession::HandleChannelOwner(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_OWNER {} Channel: {}",
        GetPlayerInfo(), channelName);
...
void WorldSession::HandleChannelModerator(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_MODERATOR {} Channel: {}, Target: {}",
        GetPlayerInfo(), channelName, targetName);
...
void WorldSession::HandleChannelUnmoderator(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNMODERATOR {} Channel: {}, Target: {}",
        GetPlayerInfo(), channelName, targetName);
...
void WorldSession::HandleChannelMute(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_MUTE {} Channel: {}, Target: {}",
        GetPlayerInfo(), channelName, targetName);
...
void WorldSession::HandleChannelUnmute(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNMUTE {} Channel: {}, Target: {}",
        GetPlayerInfo(), channelName, targetName);
...
void WorldSession::HandleChannelInvite(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_INVITE {} Channel: {}, Target: {}",
        GetPlayerInfo(), channelName, targetName);
...
void WorldSession::HandleChannelKick(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_KICK {} Channel: {}, Target: {}",
        GetPlayerInfo(), channelName, targetName);
...
void WorldSession::HandleChannelBan(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_BAN {} Channel: {}, Target: {}",
        GetPlayerInfo(), channelName, targetName);
...
void WorldSession::HandleChannelUnban(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNBAN {} Channel: {}, Target: {}",
        GetPlayerInfo(), channelName, targetName);
...
void WorldSession::HandleChannelAnnouncements(WorldPacket& recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_ANNOUNCEMENTS {} Channel: {}",
        GetPlayerInfo(), channelName);
...
void WorldSession::HandleGetChannelMemberCount(WorldPacket &recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_GET_CHANNEL_MEMBER_COUNT {} Channel: {}",
        GetPlayerInfo(), channelName);

    if (Channel* channel = ChannelMgr::GetChannelForPlayerByNamePart(channelName, GetPlayer()))
    {
        SC_LOG_DEBUG("chat.system", "SMSG_CHANNEL_MEMBER_COUNT {} Channel: {} Count: {}",
...
void WorldSession::HandleSetChannelWatch(WorldPacket &recvPacket)
{
    ...
    SC_LOG_DEBUG("chat.system", "CMSG_SET_CHANNEL_WATCH {} Channel: {}",
        GetPlayerInfo(), channelName);
