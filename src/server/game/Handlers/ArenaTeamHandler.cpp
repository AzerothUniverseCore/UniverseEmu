...
{
    SC_LOG_DEBUG("network", "MSG_INSPECT_ARENA_TEAMS");

    ObjectGuid guid;
    recvData >> guid;
    SC_LOG_DEBUG("network", "Inspect Arena stats {}", guid.ToString());
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_QUERY");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_ROSTER");
...
{
    SC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_INVITE");
    ...
    SC_LOG_DEBUG("bg.battleground", "Player {} Invited {} to Join his ArenaTeam", GetPlayer()->GetName(), invitedName);
    ...
    SC_LOG_DEBUG("network", "WORLD: Sent SMSG_ARENA_TEAM_INVITE");
}

void WorldSession::HandleArenaTeamAcceptOpcode(WorldPacket & /*recvData*/)
{
    SC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_ACCEPT");                // empty opcode
...
{
    SC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DECLINE");               // empty opcode
...
{
    SC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEAVE");
...
{
    SC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DISBAND");
...
{
    SC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_REMOVE");
...
{
    SC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEADER");
