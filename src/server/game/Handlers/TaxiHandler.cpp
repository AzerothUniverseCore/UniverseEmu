...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_TAXINODE_STATUS_QUERY");
...
void WorldSession::SendTaxiStatus(ObjectGuid guid)
{
    ...
    {
        SC_LOG_DEBUG("network", "WorldSession::SendTaxiStatus - {} not found or you can't interact with him.", guid.ToString());
        return;
    }
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_TAXIQUERYAVAILABLENODES");
    ...
    if (!unit)
    {
        SC_LOG_DEBUG("network", "WORLD: HandleTaxiQueryAvailableNodes - {} not found or you can't interact with him.", guid.ToString());
        return;
    }
...
void WorldSession::SendTaxiMenu(Creature* unit)
{
    ...
    SC_LOG_DEBUG("network", "WORLD: CMSG_TAXINODE_STATUS_QUERY {} ", curloc);
    ...
    SC_LOG_DEBUG("network", "WORLD: Sent SMSG_SHOWTAXINODES");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_ACTIVATETAXIEXPRESS");
    ...
    if (!npc)
    {
        SC_LOG_DEBUG("network", "WORLD: HandleActivateTaxiExpressOpcode - {} not found or you can't interact with it.", guid.ToString());
    ...
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_ACTIVATETAXIEXPRESS from {} to {}", nodes.front(), nodes.back());
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_MOVE_SPLINE_DONE");
...
{
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_ACTIVATETAXI");
    ...
    SC_LOG_DEBUG("network", "WORLD: Received CMSG_ACTIVATETAXI from {} to {}", nodes[0], nodes[1]);
    Creature* npc = GetPlayer()->GetNPCIfCanInteractWith(guid, UNIT_NPC_FLAG_FLIGHTMASTER);
    if (!npc)
    {
        SC_LOG_DEBUG("network", "WORLD: HandleActivateTaxiOpcode - {} not found or you can't interact with it.", guid.ToString());
        SendActivateTaxiReply(ERR_TAXITOOFARAWAY);
        return;
    }
