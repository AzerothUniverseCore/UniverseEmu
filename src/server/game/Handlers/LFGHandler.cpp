...
void WorldSession::HandleLfgJoinOpcode(WorldPackets::LFG::LFGJoin& packet)
{
    ...
    {
        SC_LOG_DEBUG("lfg", "CMSG_LFG_JOIN {} no dungeons selected", GetPlayerInfo());
        return;
    }
    ...
    SC_LOG_DEBUG("lfg", "CMSG_LFG_JOIN {} roles: %u, Dungeons: {}, Comment: {}",
...
void WorldSession::HandleLfgLeaveOpcode(WorldPackets::LFG::LFGLeave& /*packet*/)
{
    ...
    SC_LOG_DEBUG("lfg", "CMSG_LFG_LEAVE {} in group: %u",
...
void WorldSession::HandleLfgProposalResultOpcode(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("lfg", "CMSG_LFG_PROPOSAL_RESULT {} proposal: %u accept: %u",
...
void WorldSession::HandleLfgSetRolesOpcode(WorldPacket& recvData)
{
    ...
    if (!group)
    {
        SC_LOG_DEBUG("lfg", "CMSG_LFG_SET_ROLES {} Not in group",
            GetPlayerInfo());
        return;
    }
    ObjectGuid gguid = group->GetGUID();
    SC_LOG_DEBUG("lfg", "CMSG_LFG_SET_ROLES: Group {}, Player {}, Roles: %u",
...
void WorldSession::HandleLfgSetCommentOpcode(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("lfg", "CMSG_LFG_SET_COMMENT {} comment: {}",
...
void WorldSession::HandleLfgSetBootVoteOpcode(WorldPacket& recvData)
{
    ...
    ObjectGuid guid = GetPlayer()->GetGUID();
    SC_LOG_DEBUG("lfg", "CMSG_LFG_SET_BOOT_VOTE {} agree: %u",
...
void WorldSession::HandleLfgTeleportOpcode(WorldPacket& recvData)
{
    ...
    SC_LOG_DEBUG("lfg", "CMSG_LFG_TELEPORT {} out: %u",
...
{
    ObjectGuid guid = GetPlayer()->GetGUID();
    SC_LOG_DEBUG("lfg", "CMSG_LFG_PLAYER_LOCK_INFO_REQUEST {}",
        GetPlayerInfo());
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_PLAYER_INFO {}", GetPlayerInfo());
...
{
    ObjectGuid guid = GetPlayer()->GetGUID();
    SC_LOG_DEBUG("lfg", "CMSG_LFG_PARTY_LOCK_INFO_REQUEST {}", GetPlayerInfo());
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_PARTY_INFO {}", GetPlayerInfo());
...
void WorldSession::HandleLfrJoinOpcode(WorldPacket& recvData)
{
    ...
    recvData >> entry;
    SC_LOG_DEBUG("lfg", "CMSG_LFG_LFR_JOIN {} dungeon entry: %u",
        GetPlayerInfo(), entry);
...
void WorldSession::HandleLfrLeaveOpcode(WorldPacket& recvData)
{
    ...
    recvData >> dungeonId;
    SC_LOG_DEBUG("lfg", "CMSG_LFG_LFR_LEAVE {} dungeonId: %u",
...
{
    SC_LOG_DEBUG("lfg", "CMSG_LFG_GET_STATUS {}", GetPlayerInfo());
...
void WorldSession::SendLfgUpdatePlayer(lfg::LfgUpdateData const& updateData)
{
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_UPDATE_PLAYER {} updatetype: %u",
...
void WorldSession::SendLfgUpdateParty(const lfg::LfgUpdateData& updateData)
{
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_UPDATE_PARTY {} updatetype: %u",
        GetPlayerInfo(), updateData.updateType);
...
{
    SC_LOG_DEBUG("lfg", "SMSG_LFG_ROLE_CHOSEN {} guid: {} roles: %u",
...
void WorldSession::SendLfgRoleCheckUpdate(lfg::LfgRoleCheck const& roleCheck)
{
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_ROLE_CHECK_UPDATE {}", GetPlayerInfo());
...
void WorldSession::SendLfgJoinResult(lfg::LfgJoinResultData const& joinData)
{
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_JOIN_RESULT {} checkResult: %u checkValue: %u",
...
{
    SC_LOG_DEBUG("lfg", "SMSG_LFG_QUEUE_STATUS {} state: {}, dungeon: %u, waitTime: {}, "
...
void WorldSession::SendLfgPlayerReward(lfg::LfgPlayerRewardData const& rewardData)
{
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_PLAYER_REWARD {} rdungeonEntry: %u, sdungeonEntry: %u, done: %u",
...
void WorldSession::SendLfgBootProposalUpdate(lfg::LfgPlayerBoot const& boot)
{
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_BOOT_PROPOSAL_UPDATE {} inProgress: %u - "
        "didVote: %u - agree: %u - victim: {} votes: %u - agrees: %u - left: %u - "
        "needed: %u - reason {}",
...
void WorldSession::SendLfgUpdateProposal(lfg::LfgProposal const& proposal)
{
    ...
    SC_LOG_DEBUG("lfg", "SMSG_LFG_PROPOSAL_UPDATE {} state: %u",
...
{
    SC_LOG_DEBUG("lfg", "SMSG_LFG_LFR_LIST {} update: %u",
...
{
    SC_LOG_DEBUG("lfg", "SMSG_LFG_DISABLED {}", GetPlayerInfo());
...
{
    SC_LOG_DEBUG("lfg", "SMSG_LFG_OFFER_CONTINUE {} dungeon entry: %u",
...
{
    SC_LOG_DEBUG("lfg", "SMSG_LFG_TELEPORT_DENIED {} reason: %u",
        GetPlayerInfo(), err);
...
{
    SC_LOG_DEBUG("network", "SMSG_LFG_UPDATE_LIST {} dungeon entry: %u",
        GetPlayerInfo(), dungeonEntry);
