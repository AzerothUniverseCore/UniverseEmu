...
#ifndef SYPHRENACORE_QUEST_H
#define SYPHRENACORE_QUEST_H
...
enum QuestSpecialFlags
{
    ...
    // Syphrena flags for set SpecialFlags in DB if required but used only at server
...
class SC_GAME_API Quest
{
    ...
    public:
        ...
        Syphrena::unique_weak_ptr<Quest> GetWeakPtr() const { return _weakRef; }
    ...
    private:
        ...
        Syphrena::unique_weak_ptr<Quest> _weakRef;
};
