...
\********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<QuestFailedReason>::ToString(QuestFailedReason value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<QuestFailedReason>::Count() { return 13; }

template <>
SC_API_EXPORT QuestFailedReason EnumUtils<QuestFailedReason>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<QuestFailedReason>::ToIndex(QuestFailedReason value)
{
    switch (value)
    {
...
\*********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<QuestShareMessages>::ToString(QuestShareMessages value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<QuestShareMessages>::Count() { return 12; }

template <>
SC_API_EXPORT QuestShareMessages EnumUtils<QuestShareMessages>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<QuestShareMessages>::ToIndex(QuestShareMessages value)
{
    switch (value)
    {
