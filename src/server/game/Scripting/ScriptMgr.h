...
namespace Syphrena::ChatCommands { struct ChatCommandBuilder; }
...
class SC_GAME_API ScriptObject
{
...
class SC_GAME_API SpellScriptLoader : public ScriptObject
{
    protected:
...
class SC_GAME_API ServerScript : public ScriptObject
{
    protected:
...
class SC_GAME_API WorldScript : public ScriptObject
{
    protected:
...
class SC_GAME_API FormulaScript : public ScriptObject
{
    protected:
...
class SC_GAME_API WorldMapScript : public ScriptObject, public MapScript<Map>
{
    protected:
...
class SC_GAME_API InstanceMapScript : public ScriptObject, public MapScript<InstanceMap>
{
    protected:
...
class SC_GAME_API BattlegroundMapScript : public ScriptObject, public MapScript<BattlegroundMap>
{
    protected:
...
class SC_GAME_API ItemScript : public ScriptObject
{
    protected:
...
class SC_GAME_API UnitScript : public ScriptObject
{
    protected:
...
class SC_GAME_API CreatureScript : public ScriptObject
{
    protected:
...
class SC_GAME_API AllCreatureScript : public ScriptObject
{
protected:
...
class SC_GAME_API GameObjectScript : public ScriptObject
{
    protected:
...
class SC_GAME_API AreaTriggerScript : public ScriptObject
{
    protected:
...
class SC_GAME_API OnlyOnceAreaTriggerScript : public AreaTriggerScript
{
...
class SC_GAME_API BattlefieldScript : public ScriptObject
{
    protected:
...
class SC_GAME_API BattlegroundScript : public ScriptObject
{
    protected:
...
class SC_GAME_API OutdoorPvPScript : public ScriptObject
{
    protected:
...
class SC_GAME_API CommandScript : public ScriptObject
{
    protected:
    ...
    public:
        ...
        virtual std::vector<Syphrena::ChatCommands::ChatCommandBuilder> GetCommands() const = 0;
};

class SC_GAME_API WeatherScript : public ScriptObject
{
    protected:
...
class SC_GAME_API AuctionHouseScript : public ScriptObject
{
    protected:
...
class SC_GAME_API ConditionScript : public ScriptObject
{
    protected:
...
class SC_GAME_API VehicleScript : public ScriptObject
{
    protected:
...
class SC_GAME_API DynamicObjectScript : public ScriptObject
{
    protected:
...
class SC_GAME_API TransportScript : public ScriptObject
{
    protected:
...
class SC_GAME_API AchievementCriteriaScript : public ScriptObject
{
    protected:
...
class SC_GAME_API PlayerScript : public ScriptObject
{
    protected:
...
class SC_GAME_API GuildScript : public ScriptObject
{
    protected:
...
class SC_GAME_API GroupScript : public ScriptObject
{
    protected:
...
class SC_GAME_API ScriptMgr
{
    ...
    public: /* CommandScript */
        ...
        std::vector<Syphrena::ChatCommands::ChatCommandBuilder> GetChatCommands();
...
namespace Syphrena::SpellScripts
{
    template<typename T>
...
{
    using SpellScriptType = typename Syphrena::find_type_if_t<Syphrena::SpellScripts::is_SpellScript, Ts...>;
    using AuraScriptType = typename Syphrena::find_type_if_t<Syphrena::SpellScripts::is_AuraScript, Ts...>;
    using ArgsType = typename Syphrena::find_type_if_t<Syphrena::is_tuple, Ts...>;
...
private:
    ...
    {
        if constexpr (!std::is_same_v<SpellScriptType, Syphrena::find_type_end>)
            return Syphrena::new_from_tuple<SpellScriptType>(_args);
        else
            return nullptr;
    }
    ...
    {
        if constexpr (!std::is_same_v<AuraScriptType, Syphrena::find_type_end>)
            return Syphrena::new_from_tuple<AuraScriptType>(_args);
        else
            return nullptr;
    }
