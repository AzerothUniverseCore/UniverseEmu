...
namespace Syphrena
{
    ...
    class SyphrenaStringChatBuilder
    {
        public:
            SyphrenaStringChatBuilder(WorldObject const* obj, ChatMsg msgType, uint32 textId, WorldObject const* target = nullptr, va_list* args = nullptr)
