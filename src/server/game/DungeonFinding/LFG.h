...
SC_GAME_API std::string ConcatenateDungeons(LfgDungeonSet const& dungeons);
SC_GAME_API std::string GetRolesString(uint8 roles);
SC_GAME_API std::string GetStateString(LfgState state);
