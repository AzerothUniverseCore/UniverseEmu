...
#ifndef SYPHRENACORE_DYNAMICOBJECT_H
#define SYPHRENACORE_DYNAMICOBJECT_H
...
class SC_GAME_API DynamicObject : public WorldObject, public GridObject<DynamicObject>, public MapObject
{
    public:
