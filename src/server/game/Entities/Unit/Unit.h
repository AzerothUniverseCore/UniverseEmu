...
class SC_GAME_API DispelableAura
{
    public:
...
SC_GAME_API extern float baseMoveSpeed[MAX_MOVE_TYPE];
SC_GAME_API extern float playerBaseMoveSpeed[MAX_MOVE_TYPE];
...
class SC_GAME_API ProcEventInfo
{
    public:
...
struct SC_GAME_API SpellNonMeleeDamage
{
...
class SC_GAME_API Unit : public WorldObject
{
    ...
    public:
        ...
        Syphrena::unique_weak_ptr<Vehicle> GetVehicleKitWeakPtr() const { return m_vehicleKit; }
    ...
    protected:
        ...
        Vehicle* m_vehicle;
        Syphrena::unique_trackable_ptr<Vehicle> m_vehicleKit;
