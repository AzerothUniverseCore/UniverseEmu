...
class SC_GAME_API Object
{
    public:
        ...
        Syphrena::unique_weak_ptr<Object> GetWeakPtr() const { return m_scriptRef; }
    ...
    private:
        ...
        Syphrena::unique_trackable_ptr<Object> m_scriptRef;
...
class SC_GAME_API WorldObject : public Object, public WorldLocation
{
    protected:
