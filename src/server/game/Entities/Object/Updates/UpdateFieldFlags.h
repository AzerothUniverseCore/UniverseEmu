...
SC_GAME_API extern uint32 ItemUpdateFieldFlags[CONTAINER_END];
SC_GAME_API extern uint32 UnitUpdateFieldFlags[PLAYER_END];
SC_GAME_API extern uint32 GameObjectUpdateFieldFlags[GAMEOBJECT_END];
SC_GAME_API extern uint32 DynamicObjectUpdateFieldFlags[DYNAMICOBJECT_END];
SC_GAME_API extern uint32 CorpseUpdateFieldFlags[CORPSE_END];
