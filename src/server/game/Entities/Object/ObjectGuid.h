...
class SC_GAME_API PackedGuid
{
    friend SC_GAME_API ByteBuffer& operator<<(ByteBuffer& buf, PackedGuid const& guid);
...
class SC_GAME_API ObjectGuidGenerator
{
public:
...
SC_GAME_API ByteBuffer& operator<<(ByteBuffer& buf, ObjectGuid const& guid);
SC_GAME_API ByteBuffer& operator>>(ByteBuffer& buf, ObjectGuid&       guid);

SC_GAME_API ByteBuffer& operator<<(ByteBuffer& buf, PackedGuid const& guid);
SC_GAME_API ByteBuffer& operator>>(ByteBuffer& buf, PackedGuidReader const& guid);
