...
\*********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<InventoryResult>::ToString(InventoryResult value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<InventoryResult>::Count() { return 88; }

template <>
SC_API_EXPORT InventoryResult EnumUtils<InventoryResult>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<InventoryResult>::ToIndex(InventoryResult value)
{
    switch (value)
    {
...
\***************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<BuyResult>::ToString(BuyResult value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<BuyResult>::Count() { return 9; }

template <>
SC_API_EXPORT BuyResult EnumUtils<BuyResult>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<BuyResult>::ToIndex(BuyResult value)
{
    switch (value)
    {
...
\****************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SellResult>::ToString(SellResult value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SellResult>::Count() { return 7; }

template <>
SC_API_EXPORT SellResult EnumUtils<SellResult>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SellResult>::ToIndex(SellResult value)
{
    switch (value)
    {
