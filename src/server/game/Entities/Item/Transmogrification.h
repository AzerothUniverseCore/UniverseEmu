...
enum TransmogSyphrenaStrings // Language.h might have same entries, appears when executing SQL, change if needed
{
...
class SC_GAME_API Transmogrification
{
private:
    Transmogrification() { };
    ~Transmogrification() { };
...
public:
    ...
    TransmogSyphrenaStrings Transmogrify(Player* player, ObjectGuid itemGUID, uint8 slot, bool no_cost = false);
