...
enum ItemSubclassWeapon
{
    ...
    ITEM_SUBCLASS_WEAPON_WARGLAIVES             = 9, //ITEM_SUBCLASS_WEAPON_obsolete = 9,
...
enum ItemSubclassRecipe
{
    ...
    ITEM_SUBCLASS_RECYCLER_RECIPE               = 11
};
...
{
    ITEM_SUBCLASS_GLYPH_WARRIOR                 = 1, // TITLE Warrior
    ITEM_SUBCLASS_GLYPH_PALADIN                 = 2, // TITLE Paladin
    ITEM_SUBCLASS_GLYPH_HUNTER                  = 3, // TITLE Hunter
    ITEM_SUBCLASS_GLYPH_ROGUE                   = 4, // TITLE Rogue
    ITEM_SUBCLASS_GLYPH_PRIEST                  = 5, // TITLE Priest
    ITEM_SUBCLASS_GLYPH_DEATH_KNIGHT            = 6, // TITLE Death Knight
    ITEM_SUBCLASS_GLYPH_SHAMAN                  = 7, // TITLE Shaman
    ITEM_SUBCLASS_GLYPH_MAGE                    = 8, // TITLE Mage
    ITEM_SUBCLASS_GLYPH_WARLOCK                 = 9, // TITLE Warlock
    ITEM_SUBCLASS_GLYPH_BLOODMAGE               = 10, // TITLE Blood Mage
    ITEM_SUBCLASS_GLYPH_DRUID                   = 11, // TITLE Druid
    ITEM_SUBCLASS_GLYPH_KNIGHT                  = 12, // TITLE Knight
    ITEM_SUBCLASS_GLYPH_DEMON_HUNTER            = 13, // TITLE Demon Hunter
    ITEM_SUBCLASS_GLYPH_MONK                    = 14, // TITLE Monk
    ITEM_SUBCLASS_GLYPH_TAMER                   = 15, // TITLE Tamer
    ITEM_SUBCLASS_GLYPH_HERO                    = 16, // TITLE Hero
    ITEM_SUBCLASS_GLYPH_EVOKER                  = 17, // TITLE Evoker
    ITEM_SUBCLASS_GLYPH_CHRONOMANCER            = 21, // TITLE Chronomancer
    //ITEM_SUBCLASS_GLYPH_UNK                   = 19  // TITLE UNK
};

#define MAX_ITEM_SUBCLASS_GLYPH                   22
...
struct SC_GAME_API ItemTemplate
{
