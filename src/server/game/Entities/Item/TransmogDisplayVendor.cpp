...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::GetFakeEntry");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::DeleteFakeEntry");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::SetFakeEntry");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::UpdateItem");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::TransmogDisplayVendorMgr::getSlotName");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::GetSpecialPrice");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::CanTransmogrifyItemWithItem");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::SuitableForTransmogrification");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::IsRangedWeapon");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::IsAllowed");

    return std::find(Allowed.begin(), Allowed.end(), entry) != Allowed.end();
}
bool TransmogDisplayVendorMgr::IsNotAllowed(uint32 entry)
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::IsNotAllowed");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::IsAllowedQuality");
...
{
    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::HandleTransmogrify");
    ...
    {
        SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::HandleTransmogrify - {} ({}) tried to transmogrify item {} with a wrong slot ({}) when transmogrifying items.", player->GetName().c_str(), player->GetGUID().ToString().c_str(), itemEntry, slot);
    ...
    if (itemEntry)
    {
        ...
        {
            SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::HandleTransmogrify - {} ({}) tried to transmogrify with an invalid item entry {}.", player->GetName().c_str(), player->GetGUID().ToString().c_str(), itemEntry);
    ...
    {
        SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::HandleTransmogrify - {} ({}) tried to transmogrify an invalid item in a valid slot (slot: {}).", player->GetName().c_str(), player->GetGUID().ToString().c_str(), slot);
    ...
    else
    {
        ...
        {
            SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::HandleTransmogrify - {} ({}) failed CanTransmogrifyItemWithItem ({} with {}).", player->GetName().c_str(), player->GetGUID().ToString().c_str(), itemTransmogrified->GetEntry(), itemTransmogrifier->ItemId);
        ...
        if (!no_cost)
        {
            ...
            if (cost) // 0 cost if reverting look
            {
                if (cost < 0)
                {
                    SC_LOG_DEBUG("custom.transmog", "TransmogDisplayVendorMgr::HandleTransmogrify - {} ({}) transmogrification invalid cost (non negative, amount %i). Transmogrified {} with {}", player->GetName().c_str(), player->GetGUID().ToString().c_str(), -cost, itemTransmogrified->GetEntry(), itemTransmogrifier->ItemId);
                }
                else
                {
