...
#ifndef __SYPHRENA_VEHICLE_H
#define __SYPHRENA_VEHICLE_H
...
class SC_GAME_API Vehicle : public TransportBase
{
    public:
        ...
        Syphrena::unique_weak_ptr<Vehicle> GetWeakPtr() const;
...
class SC_GAME_API VehicleJoinEvent : public BasicEvent
{
