...
#ifndef SYPHRENACORE_TEMPSUMMON_H
#define SYPHRENACORE_TEMPSUMMON_H
...
class SC_GAME_API TempSummon : public Creature
{
    public:
...
class SC_GAME_API Minion : public TempSummon
{
    public:
...
class SC_GAME_API Guardian : public Minion
{
    public:
...
class SC_GAME_API Puppet : public Minion
{
    public:
...
class SC_GAME_API ForcedUnsummonDelayEvent : public BasicEvent
{
public:
