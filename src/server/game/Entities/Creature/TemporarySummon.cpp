...
void TempSummon::Update(uint32 diff)
{
    ...
    switch (m_type)
    {
        ...
        default:
            UnSummon();
            SC_LOG_ERROR("entities.unit", "Temporary summoned creature (entry: {}) have unknown type {} of ", GetEntry(), m_type);
            break;
    }
}
...
void TempSummon::RemoveFromWorld()
{
    ...
    //if (GetOwnerGUID())
    //    SC_LOG_ERROR("entities.unit", "Unit {} has owner guid when removed from world", GetEntry());
