...
#ifndef SYPHRENACORE_CREATURE_H
#define SYPHRENACORE_CREATURE_H
...
class SC_GAME_API Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        uint32 ContinentScalingRecheckTimer = 0;
...
class SC_GAME_API AssistDelayEvent : public BasicEvent
{
    public:
...
class SC_GAME_API ForcedDespawnDelayEvent : public BasicEvent
{
    public:
