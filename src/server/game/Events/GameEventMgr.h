...
#ifndef SYPHRENA_GAMEEVENT_MGR_H
#define SYPHRENA_GAMEEVENT_MGR_H
...
class SC_GAME_API GameEventMgr
{
    private:
        GameEventMgr();
        ~GameEventMgr() { }
...
SC_GAME_API bool IsHolidayActive(HolidayIds id);
SC_GAME_API bool IsEventActive(uint16 eventId);
