...
\************************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<AuctionQuality>::ToString(AuctionQuality value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<AuctionQuality>::Count() { return 7; }

template <>
SC_API_EXPORT AuctionQuality EnumUtils<AuctionQuality>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<AuctionQuality>::ToIndex(AuctionQuality value)
{
    switch (value)
    {
...
\**************************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<AuctionHouseType>::ToString(AuctionHouseType value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<AuctionHouseType>::Count() { return 3; }

template <>
SC_API_EXPORT AuctionHouseType EnumUtils<AuctionHouseType>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<AuctionHouseType>::ToIndex(AuctionHouseType value)
{
    switch (value)
    {
