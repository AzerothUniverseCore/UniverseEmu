...
#ifndef SYPHRENA_GRIDNOTIFIERS_H
#define SYPHRENA_GRIDNOTIFIERS_H
...
namespace Syphrena
{
    struct SC_GAME_API VisibleNotifier
    {
        Player &i_player;
        UpdateData i_data;
    ...
    struct SC_GAME_API PlayerRelocationNotifier : public VisibleNotifier
    {
    ...
    struct SC_GAME_API CreatureRelocationNotifier
    {
        Creature &i_creature;
    ...
    struct SC_GAME_API DelayedUnitRelocation
    {
        Map &i_map;
        Cell &cell;
        CellCoord &p;
    ...
    struct SC_GAME_API AIRelocationNotifier
    {
        Unit &i_unit;
        bool isCreature;
    ...
    struct SC_GAME_API MessageDistDeliverer
    {
    ...
    struct SC_GAME_API MessageDistDelivererToHostile
    {
        Unit* i_source;
        WorldPacket const* i_message;
        uint32 i_phaseMask;
    ...
    class SC_GAME_API AnyDeadUnitObjectInRangeCheck
    {
        public:
    ...
    class SC_GAME_API AnyDeadUnitSpellTargetInRangeCheck : public AnyDeadUnitObjectInRangeCheck, public WorldObjectSpellTargetCheck
    {
        public:
