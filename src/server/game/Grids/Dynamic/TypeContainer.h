...
#ifndef SYPHRENA_TYPECONTAINER_H
#define SYPHRENA_TYPECONTAINER_H
...
public:
    ...
    //{
    //    SPECIFIC_TYPE* t = Syphrena::Remove(i_elements, obj);
    //    return (t != nullptr);
    //}
...
{
    return Syphrena::Count(i_elements, (SPECIFIC_TYPE*)nullptr);
}
...
{
    SPECIFIC_TYPE* t = Syphrena::Insert(i_elements, obj);
    return (t != nullptr);
}
...
{
    return Syphrena::Insert(_elements, handle, obj);
}
...
{
    return Syphrena::Remove(_elements, handle, (SPECIFIC_TYPE*)nullptr);
}
...
{
    return Syphrena::Find(_elements, handle, (SPECIFIC_TYPE*)nullptr);
}
...
{
    std::size_t size = 0;
    Syphrena::Size(_elements, &size, (SPECIFIC_TYPE*)nullptr);
    return size;
}
