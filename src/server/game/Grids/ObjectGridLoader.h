...
#ifndef SYPHRENA_OBJECTGRIDLOADER_H
#define SYPHRENA_OBJECTGRIDLOADER_H
...
class SC_GAME_API ObjectGridLoader
{
...
class SC_GAME_API ObjectGridStoper
{
    public:
        void Visit(CreatureMapType &m);
...
class SC_GAME_API ObjectGridEvacuator
{
    public:
        void Visit(CreatureMapType &m);
        void Visit(GameObjectMapType &m);
