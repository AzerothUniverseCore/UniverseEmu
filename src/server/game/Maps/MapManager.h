...
#ifndef SYPHRENA_MAPMANAGER_H
#define SYPHRENA_MAPMANAGER_H
...
class SC_GAME_API MapManager
{
    public:
        ...
        {
            return IsValidMAP(mapid, false) && Syphrena::IsValidMapCoord(x, y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z)
        {
            return IsValidMAP(mapid, false) && Syphrena::IsValidMapCoord(x, y, z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z, float o)
        {
            return IsValidMAP(mapid, false) && Syphrena::IsValidMapCoord(x, y, z, o);
        }
    ...
    private:
        typedef std::unordered_map<uint32, Syphrena::unique_trackable_ptr<Map>> MapMapType;
