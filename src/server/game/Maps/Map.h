...
#ifndef SYPHRENA_MAP_H
#define SYPHRENA_MAP_H
...
namespace Syphrena { struct ObjectUpdater; }
...
struct SC_GAME_API RespawnInfo
{
	virtual ~RespawnInfo();
...
class SC_GAME_API Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<Syphrena::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<Syphrena::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            GridCoord p = Syphrena::ComputeGridCoord(x, y);
        ...
        bool IsGridLoaded(float x, float y) const { return IsGridLoaded(Syphrena::ComputeGridCoord(x, y)); }
        ...
        Syphrena::unique_weak_ptr<Map> GetWeakPtr() const { return m_weakRef; }
        void SetWeakPtr(Syphrena::unique_weak_ptr<Map> weakRef) { m_weakRef = std::move(weakRef); }
    ...
    protected:
        ...
        uint8 i_spawnMode;
        uint32 i_InstanceId;
        Syphrena::unique_weak_ptr<Map> m_weakRef;
...
class SC_GAME_API InstanceMap : public Map
{
    public:
...
class SC_GAME_API BattlegroundMap : public Map
{
    public:
