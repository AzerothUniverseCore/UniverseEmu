...
#ifndef SYPHRENA_AREA_BOUNDARY_H
#define SYPHRENA_AREA_BOUNDARY_H

#include "Position.h"

class SC_GAME_API AreaBoundary
{
    public:
...
class SC_GAME_API RectangleBoundary : public AreaBoundary
{
    public:
...
class SC_GAME_API CircleBoundary : public AreaBoundary
{
    public:
...
class SC_GAME_API EllipseBoundary : public AreaBoundary
{
    public:
...
class SC_GAME_API TriangleBoundary : public AreaBoundary
{
    public:
...
class SC_GAME_API ParallelogramBoundary : public AreaBoundary
{
    public:
...
class SC_GAME_API ZRangeBoundary : public AreaBoundary
{
    public:
...
class SC_GAME_API BoundaryUnionBoundary : public AreaBoundary
{
    public:
...
#endif //SYPHRENA_AREA_BOUNDARY_H
