...
#ifndef SYPHRENA_SPAWNDATA_H
#define SYPHRENA_SPAWNDATA_H
...
namespace Syphrena { namespace Impl {
    template <typename T>
...
struct SpawnMetadata
{
    ...
    template <typename T>
    static constexpr SpawnObjectType TypeFor = Syphrena::Impl::SpawnObjectTypeForImpl<T>::value;
