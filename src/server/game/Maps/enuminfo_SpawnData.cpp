...
\*******************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<SpawnObjectType>::ToString(SpawnObjectType value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpawnObjectType>::Count() { return 2; }

template <>
SC_API_EXPORT SpawnObjectType EnumUtils<SpawnObjectType>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<SpawnObjectType>::ToIndex(SpawnObjectType value)
{
    switch (value)
    {
