...
#ifndef __SYPHRENA_ACHIEVEMENTMGR_H
#define __SYPHRENA_ACHIEVEMENTMGR_H
...
struct SC_GAME_API AchievementCriteriaDataSet
{
...
class SC_GAME_API AchievementMgr
{
    public:
...
class SC_GAME_API AchievementGlobalMgr
{
