...
namespace LuaWorldObject
{
    ...
    */
    ...
    int GetNearestPlayer(lua_State* L, WorldObject* obj)
    {
        ...
        Syphrena::UnitLastSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(obj, target, checker);
    ...
    int GetNearestGameObject(lua_State* L, WorldObject* obj)
    {
        ...
        Syphrena::GameObjectLastSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(obj, target, checker);
        Cell::VisitAllObjects(obj, searcher, range);
    ...
    int GetNearestCreature(lua_State* L, WorldObject* obj)
    {
        ...
        Syphrena::CreatureLastSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(obj, target, checker);
        Cell::VisitAllObjects(obj, searcher, range);
    ...
    int GetPlayersInRange(lua_State* L, WorldObject* obj)
    {
        ...
        Syphrena::PlayerListSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(obj, list, checker);
        Cell::VisitAllObjects(obj, searcher, range);
    ...
    int GetCreaturesInRange(lua_State* L, WorldObject* obj)
    {
        ...
        Syphrena::CreatureListSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(obj, list, checker);
        Cell::VisitAllObjects(obj, searcher, range);
    ...
    int GetGameObjectsInRange(lua_State* L, WorldObject* obj)
    {
        ...
        Syphrena::GameObjectListSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(obj, list, checker);
        Cell::VisitAllObjects(obj, searcher, range);
    ...
    int GetNearObject(lua_State* L, WorldObject* obj)
    {
        ...
        Syphrena::WorldObjectLastSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(obj, target, checker);
        Cell::VisitAllObjects(obj, searcher, range);
    ...
    int GetNearObjects(lua_State* L, WorldObject* obj)
    {
        ...
        Syphrena::WorldObjectListSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(obj, list, checker);
        Cell::VisitAllObjects(obj, searcher, range);
