...
namespace LuaPlayer
{
     ...
     *
     * @param bool isRaid = true : argument is SyphrenaCore only
     ...
     * @param [Player] receiver : is the [Player] that will receive the whisper, if SyphrenaCore
     * @param ObjectGuid guid : is the GUID of a [Player] that will receive the whisper, not SyphrenaCore
     */
