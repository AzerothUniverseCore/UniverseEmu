...
namespace LuaUnit
{
    ...
    */
    ...
    int GetFriendlyUnitsInRange(lua_State* L, Unit* unit)
    {
        ...
        std::list<Unit*> list;
        Syphrena::AnyFriendlyUnitInObjectRangeCheck checker(unit, unit, range);
        Syphrena::UnitListSearcher<Syphrena::AnyFriendlyUnitInObjectRangeCheck> searcher(unit, list, checker);
    ...
    int GetUnfriendlyUnitsInRange(lua_State* L, Unit* unit)
    {
        ...
        std::list<Unit*> list;
        Syphrena::AnyUnfriendlyUnitInObjectRangeCheck checker(unit, unit, range);
        Syphrena::UnitListSearcher<Syphrena::AnyUnfriendlyUnitInObjectRangeCheck> searcher(unit, list, checker);
        Cell::VisitAllObjects(unit, searcher, range);
