...
### Merging Eluna with SyphrenaCore
```
git clone https://github.com/SyphrenaCore/SyphrenaCore.git -b3.3.5
cd SyphrenaCore
...
3. pull the Eluna fork. This will fetch the repository and merge it with your source.
  ...
  * it is important that you choose the correct Eluna fork for your core and patch:
    * [Eluna SyphrenaCore WotLK](https://github.com/ElunaLuaEngine/ElunaTrinityWotlk)
    * [Eluna SyphrenaCore Cataclysm](https://github.com/ElunaLuaEngine/ElunaTrinityCata)
