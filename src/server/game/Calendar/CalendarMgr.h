...
#ifndef SYPHRENA_CALENDARMGR_H
#define SYPHRENA_CALENDARMGR_H
...
struct SC_GAME_API CalendarInvite
{
    public:
...
struct SC_GAME_API CalendarEvent
{
    public:
