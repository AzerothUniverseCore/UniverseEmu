...
#ifndef SYPHRENA_COMBATAI_H
#define SYPHRENA_COMBATAI_H

#include "CreatureAI.h"

class Creature;

class SC_GAME_API AggressorAI : public CreatureAI
{
    public:
...
class SC_GAME_API CombatAI : public CreatureAI
{
    public:
...
class SC_GAME_API CasterAI : public CombatAI
{
    public:
...
struct SC_GAME_API ArcherAI : public CreatureAI
{
    public:
...
struct SC_GAME_API TurretAI : public CreatureAI
{
    public:
...
struct SC_GAME_API VehicleAI : public CreatureAI
{
    public:
