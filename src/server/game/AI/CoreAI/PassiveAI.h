...
#ifndef SYPHRENA_PASSIVEAI_H
#define SYPHRENA_PASSIVEAI_H

#include "CreatureAI.h"

class SC_GAME_API PassiveAI : public CreatureAI
{
    public:
...
class SC_GAME_API PossessedAI : public CreatureAI
{
    public:
...
class SC_GAME_API NullCreatureAI : public CreatureAI
{
    public:
...
class SC_GAME_API CritterAI : public PassiveAI
{
    public:
...
class SC_GAME_API TriggerAI : public NullCreatureAI
{
    public:
