...
#ifndef SYPHRENA_UNITAI_H
#define SYPHRENA_UNITAI_H
...
struct SC_GAME_API DefaultTargetSelector
{
    public:
...
struct SC_GAME_API SpellTargetSelector
{
    public:
...
struct SC_GAME_API NonTankTargetSelector
{
    public:
...
struct SC_GAME_API PowerUsersSelector
{
    public:
...
struct SC_GAME_API FarthestTargetSelector
{
    public:
