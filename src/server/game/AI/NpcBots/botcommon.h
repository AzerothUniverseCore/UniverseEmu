...
enum BotClasses : uint8
{
    ...
    BOT_CLASS_BLOODMAGE                 = CLASS_BLOODMAGE,
    BOT_CLASS_DRUID                     = CLASS_DRUID,
    BOT_CLASS_KNIGHT                    = CLASS_KNIGHT,
    BOT_CLASS_DEMON_HUNTER              = CLASS_DEMON_HUNTER,
    BOT_CLASS_MONK                      = CLASS_MONK,
    BOT_CLASS_TAMER                     = CLASS_TAMER,
    BOT_CLASS_HERO                      = CLASS_HERO,
    BOT_CLASS_EVOKER                    = CLASS_EVOKER,
    BOT_CLASS_CHRONOMANCER              = CLASS_CHRONOMANCER,
...
constexpr uint32 ALL_BOT_CLASSES_MASK =
    ...
    (1 << BOT_CLASS_DEATH_KNIGHT)|(1 << BOT_CLASS_SHAMAN)|(1 << BOT_CLASS_MAGE)|(1 << BOT_CLASS_WARLOCK)|(1 << BOT_CLASS_BLOODMAGE)|
    (1 << BOT_CLASS_DRUID)|(1 << CLASS_KNIGHT)|(1 << CLASS_DEMON_HUNTER)|(1 << CLASS_MONK)|(1 << CLASS_TAMER)|(1 << CLASS_HERO)|
    (1 << CLASS_EVOKER)|(1 << CLASS_CHRONOMANCER)|
