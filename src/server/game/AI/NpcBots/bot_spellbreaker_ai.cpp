...
*/
    ...
    private:
        ...
        void ProcessSpellsteal(Unit* target)
        {
            ...
            //SC_LOG_ERROR("entities.unit", "ProcessSpellsteal: on {}, fr={}", target->GetName(), uint32(isFriend));
            ...
            for (Unit::AuraMap::const_iterator itr = auras.begin(); itr != auras.end(); ++itr)
            {
                ...
                if (!chance)
                    continue;
                //SC_LOG_ERROR("entities.unit", "{}", aura->GetSpellInfo()->SpellName[0]);
            ...
            //SC_LOG_ERROR("entities.unit", "failcount...");
            ...
            //SC_LOG_ERROR("entities.unit", "logs and auras");
            ...
            if (isFriend) //negative spell from friend to enemy
            {
                ...
                //Syphrena::AnyUnfriendlyAttackableVisibleUnitInObjectRangeCheck check(me, 50.f);
                //Syphrena::UnitListSearcher<Syphrena::AnyUnfriendlyAttackableVisibleUnitInObjectRangeCheck> searcher(me, targets, check);
            ...
            if (!targets.empty())
            {
                ...
                randomTarget = Syphrena::Containers::SelectRandomContainerElement(!targets.empty() ? targets : targetsCopy);
            }
