...
#ifndef SYPHRENA_SCRIPTEDCREATURE_H
#define SYPHRENA_SCRIPTEDCREATURE_H
...
class SC_GAME_API EntryCheckPredicate
{
    public:
...
class SC_GAME_API DummyEntryCheckPredicate
{
    public:
        bool operator()(ObjectGuid) { return true; }
};

struct SC_GAME_API ScriptedAI : public CreatureAI
{
    public:
...
class SC_GAME_API BossAI : public ScriptedAI
{
    public:
...
class SC_GAME_API WorldBossAI : public ScriptedAI
{
    public:
...
#endif // SYPHRENA_SCRIPTEDCREATURE_H
