...
void CreatureAI::DoZoneInCombat(Creature* creature /*= nullptr*/)
{
    ...
    {
        SC_LOG_ERROR("scripts.ai", "CreatureAI::DoZoneInCombat: call for map that isn't an instance ({})", creature->GetGUID().ToString());
        return;
    }
...
void CreatureAI::EnterEvadeMode(EvadeReason why)
{
    ...
    SC_LOG_DEBUG("scripts.ai", "CreatureAI::EnterEvadeMode: entering evade mode (why: {}) ({})", why, me->GetGUID().ToString());
...
void CreatureAI::EngagementStart(Unit* who)
{
    if (_isEngaged)
    {
        SC_LOG_ERROR("scripts.ai", "CreatureAI::EngagementStart called even though creature is already engaged. Creature debug info:\n{}", me->GetDebugInfo());
        return;
    }
    _isEngaged = true;
...
void CreatureAI::EngagementOver()
{
    if (!_isEngaged)
    {
        SC_LOG_DEBUG("scripts.ai", "CreatureAI::EngagementOver called even though creature is not currently engaged. Creature debug info:\n{}", me->GetDebugInfo());
        return;
    }
    _isEngaged = false;
