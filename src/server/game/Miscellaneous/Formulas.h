...
#ifndef SYPHRENA_FORMULAS_H
#define SYPHRENA_FORMULAS_H
        ...
        inline uint32 BaseGain(uint8 pl_level, uint8 mob_level, ContentLevels content)
        {
            ...
            switch (content)
            {
                ...
                case CONTENT_71_80:
                    ...
                    break;
                default:
                    SC_LOG_ERROR("misc", "BaseGain: Unsupported content level {}", content);
                    nBaseExp = 45;
                    break;
            }
