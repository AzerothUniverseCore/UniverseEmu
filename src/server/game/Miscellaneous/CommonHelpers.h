...
#ifndef SYPHRENA_COMMONHELPERS_H
#define SYPHRENA_COMMONHELPERS_H
...
namespace Syphrena
{
    namespace Helpers
    {
        namespace Entity
        {
            ...
            SC_GAME_API uint8 GetPlayerSpecialization(Player const* who);
            SC_GAME_API bool IsPlayerHealer(Player const* who);
            bool IsPlayerRangedAttacker(Player const* who);
        }
    }
}

#endif //SYPHRENA_COMMONHELPERS_H
