...
enum PlayerSpecializationIconicSpellIds
{
    ...
    /* Blood Battle Mage - Blood Magic */
    SPELL_BLOODMAGIC = 25827,

    /* Blood Battle Mage - Blood Sacrifice */
    SPELL_BLOODSACRIFICE = 26931,

    /* Blood Battle Mage - Blood Wound */
    SPELL_BLOODWOUND = 25818,

    /* Blood Battle Mage - Blood Battle Mage */
    SPELL_BLOODBATTLEMAGE = 26932,
    ...
    SPELL_DEVASTATION = 4961,

    /* Demon Hunter - Vengeance */
    SPELL_VENGEANCE = 7587,
    ...
    /* Tamer - Magicdeath */
    SPELL_MAGICDEATH = 2206,

    /* Hero - Strength */
    SPELL_STRENGTH = 335904,

    /* Hero - Address */
    SPELL_ADDRESS = 335905,
...
static const uint32 PlayerSpecializationIconicSpells[MAX_CLASSES][MAX_TALENT_TREES][MaximumSpecializationIconicSpells] = {
    ...
    { // CLASS_BLOODMAGE
        {SPELL_BLOODMAGIC}, // Blood Magic
        {SPELL_BLOODSACRIFICE}, // Blood Sacrifice
        {SPELL_BLOODWOUND} // Blood Wound
    },
    { // CLASS_DRUID
    ...
    { // CLASS_DEMON_HUNTER
        {SPELL_DEVASTATION}, // Devastation
        {SPELL_VENGEANCE}, // Vengeance
        {SPELL_MASTER} // Master
    },
    { // CLASS_MONK
    ...
    { // CLASS_TAMER
        {SPELL_WICKEDNESS}, // Wickedness
        {SPELL_CURSES}, // Curses
        {SPELL_MAGICDEATH} // Magicdeath
    },
    { // CLASS_HERO
        {SPELL_STRENGTH}, // Strength
        {SPELL_ADDRESS}, // Address
        {SPELL_POWER} // Power
    },
    { // CLASS_UNK
        {0,0,0},
...
uint8 Syphrena::Helpers::Entity::GetPlayerSpecialization(Player const* who)
{
    if (!who)
        return 0;
...
bool Syphrena::Helpers::Entity::IsPlayerHealer(Player const* who)
{
    if (!who)
        return false;
    ...
    switch (who->GetClass())
    {
        ...
        default:
            return false;
        case CLASS_PALADIN:
            return (Syphrena::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_PALADIN_HOLY);
        case CLASS_PRIEST:
            return (Syphrena::Helpers::Entity::GetPlayerSpecialization(who) != SPEC_PRIEST_SHADOW);
        case CLASS_SHAMAN:
            return (Syphrena::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_SHAMAN_RESTORATION);
        case CLASS_DRUID:
            return (Syphrena::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_DRUID_RESTORATION);
    }
}

bool Syphrena::Helpers::Entity::IsPlayerRangedAttacker(Player const* who)
{
    if (!who)
        return false;
    ...
    switch (who->GetClass())
    {
        ...
        case CLASS_PRIEST:
            return (Syphrena::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_PRIEST_SHADOW);
        case CLASS_SHAMAN:
            return (Syphrena::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_SHAMAN_ELEMENTAL);
        case CLASS_DRUID:
            return (Syphrena::Helpers::Entity::GetPlayerSpecialization(who) == SPEC_DRUID_BALANCE);
    }
}
