...
#ifndef SYPHRENA_COMBATMANAGER_H
#define SYPHRENA_COMBATMANAGER_H
...
struct SC_GAME_API CombatReference
{
    Unit* const first;
    Unit* const second;
    bool const _isPvP;
...
// Please check Game/Combat/CombatManager.h for documentation on how this class works!
struct SC_GAME_API PvPCombatReference : public CombatReference
{
...
// please check Game/Combat/CombatManager.h for documentation on how this class works!
class SC_GAME_API CombatManager
{
    public:
