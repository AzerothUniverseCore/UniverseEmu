 ...
 */
 ...
 #ifndef SYPHRENA_THREATMANAGER_H
 #define SYPHRENA_THREATMANAGER_H
...
class SC_GAME_API ThreatManager
{
    public:
        class Heap;
        ...
        Syphrena::IteratorPair<ThreatListIterator, std::nullptr_t> GetUnsortedThreatList() const;
        ...
        Syphrena::IteratorPair<ThreatListIterator, std::nullptr_t> GetSortedThreatList() const;
...
// Please check Game/Combat/ThreatManager.h for documentation on how this class works!
class SC_GAME_API ThreatReference
{
    public:
