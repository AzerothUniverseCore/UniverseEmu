...
#ifndef SYPHRENA_MAIL_H
#define SYPHRENA_MAIL_H
...
class SC_GAME_API MailReceiver
{
    public:                                                 // Constructors
