...
#ifndef SYPHRENACORE_GUILD_H
#define SYPHRENACORE_GUILD_H
...
class SC_GAME_API Guild
{
    ...
    public:
        ...
        Syphrena::unique_weak_ptr<Guild> GetWeakPtr() const { return m_weakRef; }
        void SetWeakPtr(Syphrena::unique_weak_ptr<Guild> weakRef) { m_weakRef = std::move(weakRef); }
    ...
    protected:
        ...
        Syphrena::unique_weak_ptr<Guild> m_weakRef;
