...
\**********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<WardenActions>::ToString(WardenActions value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<WardenActions>::Count() { return 3; }

template <>
SC_API_EXPORT WardenActions EnumUtils<WardenActions>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<WardenActions>::ToIndex(WardenActions value)
{
    switch (value)
    {
...
\****************************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<WardenCheckCategory>::ToString(WardenCheckCategory value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<WardenCheckCategory>::Count() { return 3; }

template <>
SC_API_EXPORT WardenCheckCategory EnumUtils<WardenCheckCategory>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<WardenCheckCategory>::ToIndex(WardenCheckCategory value)
{
    switch (value)
    {
...
\************************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<WardenCheckType>::ToString(WardenCheckType value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<WardenCheckType>::Count() { return 9; }

template <>
SC_API_EXPORT WardenCheckType EnumUtils<WardenCheckType>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<WardenCheckType>::ToIndex(WardenCheckType value)
{
    switch (value)
    {
