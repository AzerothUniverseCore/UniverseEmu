...
class SC_GAME_API WorldSocketMgr : public SocketMgr<WorldSocket>
{
...
public:
    ...
    bool StartWorldNetwork(Syphrena::Asio::IoContext& ioContext, std::string const& bindIp, uint16 port, int networkThreads);
