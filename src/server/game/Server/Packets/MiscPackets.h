...
namespace WorldPackets
{
    namespace Misc
    {
        ...
        class SC_GAME_API Weather final : public ServerPacket
        {
        public:
            Weather();
        ...
        class SC_GAME_API PlayMusic final : public ServerPacket
        {
        public:
        ...
        class SC_GAME_API PlayObjectSound final : public ServerPacket
        {
        public:
        ...
        class SC_GAME_API PlaySound final : public ServerPacket
        {
        public:
