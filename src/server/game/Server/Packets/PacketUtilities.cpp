...
{
    if (!Syphrena::Hyperlinks::CheckAllLinks(value))
...
{
    message().assign("Attempted to read more array elements from packet " + Syphrena::ToString(requestedSize) + " than allowed " + Syphrena::ToString(sizeLimit));
}
