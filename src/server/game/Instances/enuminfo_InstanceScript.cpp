...
\***********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<EncounterState>::ToString(EncounterState value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<EncounterState>::Count() { return 6; }

template <>
SC_API_EXPORT EncounterState EnumUtils<EncounterState>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<EncounterState>::ToIndex(EncounterState value)
{
    switch (value)
    {
