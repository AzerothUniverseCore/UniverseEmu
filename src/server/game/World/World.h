...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_AUTORESTART_WORLDSERVER, //SyphrenaCore
...
struct SC_GAME_API CliCommandHolder
{
...
SC_GAME_API extern Realm realm;
