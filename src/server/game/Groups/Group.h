...
#ifndef SYPHRENACORE_GROUP_H
#define SYPHRENACORE_GROUP_H
...
class SC_GAME_API Group
{
    ...
    public:
        ...
        Syphrena::unique_weak_ptr<Group> GetWeakPtr() const { return m_scriptRef; }
    ...
    protected:
        ...
        Syphrena::unique_trackable_ptr<Group> m_scriptRef;
};
#endif
