...
class SC_GAME_API SpellMgr
{
    ...
    public:
        ...
        Syphrena::IteratorPair<SpellRequiredMap::const_iterator> GetSpellsRequiredForSpellBounds(uint32 spell_id) const;
