 ...
 */
#ifndef SYPHRENA_SPELLAURADEFINES_H
#define SYPHRENA_SPELLAURADEFINES_H
...
enum ShapeshiftForm
{
    ...
    FORM_DEMONHUNTER_METAMORPHOSIS = 0x21,
    FORM_DH_FLY             = 0x22,
    FORM_DH_METAMORPHOSIS   = 0x23,
    FORM_TIGER              = 0x24,
    FORM_OX                 = 0x25,
    FORM_SERPENT            = 0x26,
    FORM_FORCE              = 0x27,
...
struct SC_GAME_API AuraCreateInfo
{
    friend class Aura;
