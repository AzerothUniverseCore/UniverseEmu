...
#ifndef SYPHRENA_SPELLAURAS_H
#define SYPHRENA_SPELLAURAS_H
...
class SC_GAME_API AuraApplication
{
    friend class Unit;
...
class SC_GAME_API Aura
{
    ...
    public:
        ...
        Syphrena::unique_weak_ptr<Aura> GetWeakPtr() const { return m_scriptRef; }
    ...
    private:
        ...
        Syphrena::unique_trackable_ptr<Aura> m_scriptRef;
};

class SC_GAME_API UnitAura : public Aura
{
...
class SC_GAME_API DynObjAura : public Aura
{
    friend Aura* Aura::Create(AuraCreateInfo& createInfo);
    protected:
...
class SC_GAME_API ChargeDropEvent : public BasicEvent
{
    friend class Aura;
    protected:
