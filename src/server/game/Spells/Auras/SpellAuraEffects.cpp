...
// such checks will speedup syphrena change amount/send for client operations
...
pAuraEffectHandler AuraEffectHandler[TOTAL_AURAS]=
{
    ...
    &AuraEffect::HandleNoImmediateEffect,                         //316 Scase FORM_SPIRITOFREDEMPTION:                       // 0x20PELL_AURA_PERIODIC_HASTE implemented in AuraEffect::CalculatePeriodic
...
void AuraEffect::HandleAuraModShapeshift(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    switch (form)
    {
        ...
        case FORM_DEMONHUNTER_METAMORPHOSIS:                // 0x21
        case FORM_DH_FLY:                                   // 0x22
        case FORM_DH_METAMORPHOSIS:                         // 0x23
        case FORM_TIGER:                                    // 0x24
        case FORM_OX:                                       // 0x25
        case FORM_SERPENT:                                  // 0x26
        case FORM_FORCE:                                    // 0x27
        case FORM_ADRESSE:                                  // 0x28
        case FORM_VOLONTE:                                  // 0x29
            break;
        default:
            SC_LOG_ERROR("spells.aura.effect", "Auras: Unknown Shapeshift Type: {}", GetMiscValue());
    }
        ...
        if (!transformSpellInfo || !GetSpellInfo()->IsPositive() || transformSpellInfo->IsPositive())
        {
                ...
                switch (GetId())
                {
                    ...
                    case 16739:
                    {
                        ...
                        switch (target->GetRace())
                        {
                            // Blood Elf
                            case RACE_BLOODELF:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 17830 : 17829); // Draenei
                                break;
                            // Orc
                            case RACE_ORC:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10140 : 10139); // Human
                                break;
                            // Troll
                            case RACE_TROLL:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10134 : 10135); // Nain
                                break;
                            // Tauren
                            case RACE_TAUREN:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10147 : 10136); // Gnome
                                break;
                            // Undead
                            case RACE_UNDEAD_PLAYER:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10145 : 10146); // Night Elf
                                break;
                            // Draenei
                            case RACE_DRAENEI:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 17828 : 17827); // Blood Elf
                                break;
                            // Dwarf
                            case RACE_DWARF:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10142 : 10141); // Troll
                                break;
                            // Gnome
                            case RACE_GNOME:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10149 : 10148); // Tauren
                                break;
                            // Human
                            case RACE_HUMAN:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10138 : 10137); // Orc
                                break;
                            // Night Elf
                            case RACE_NIGHTELF:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10144 : 10143); // Undead
                                break;
                            // Goblin
                            case RACE_GOBLIN_:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10149 : 10148); // Tauren
                            ...
                            case RACE_PANDAREN_ALLIANCE:
                                ...
                                break;
                            // Blood Elf Illidari
                            case RACE_BLOODELF_ILLIDARI:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 17830 : 17829); // Draenei
                                break;
                            // Night Elf Illidari
                            case RACE_NIGHTELF_ILLIDARI:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10144 : 10143); // Undead
                                break;
                            // Eredar
                            case RACE_EREDAR:
                            ...
                            case RACE_DARK_IRON_DWARF:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10142 : 10141); // Troll
                                break;
                            // Dark Iron Dwarf Horde
                            case RACE_DARK_IRON_DWARF_H:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 10142 : 10141); // Troll
                                break;
                            // High Elf Alliance
                            case RACE_HIGHELF:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 36404 : 36403); // Broken
                                break;
                            // High mountain Tauren Horde
                            case RACE_HIGHMOUNTAINTAUREN:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 36406 : 36405); // High mountain Tauren
                                break;
                            // Vulpera
                            case RACE_VULPERA_A:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 36402 : 36401); // Vulpera
                                break;
                            // Human Horde
                            ...
                            // Mag'har Horde
                            case RACE_MAGHAR:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 17830 : 17829); // Mag'har Horde
                                break;
                            // Kultiran Alliance
                            case RACE_KULTIRAN:
                                target->SetDisplayId(gender == GENDER_FEMALE ? 17830 : 17829); // Kultiran Alliance
                                break;
                            default:
                                break;
                        }
                    ...
                    case 51926:
                    {
                        ...
                        switch (target->GetRace())
                        {
                            // Blood Elf
                            case RACE_BLOODELF:
                                target->SetDisplayId(gender == GENDER_MALE ? 25032 : 25043); // Blood Elf
                                break;
                            // Orc
                            case RACE_ORC:
                                target->SetDisplayId(gender == GENDER_MALE ? 25039 : 25050); // Orc
                                break;
                            // Troll
                            case RACE_TROLL:
                                target->SetDisplayId(gender == GENDER_MALE ? 25041 : 25052); // Troll
                                break;
                            // Tauren
                            case RACE_TAUREN:
                                target->SetDisplayId(gender == GENDER_MALE ? 25040 : 25051); // Tauren
                                break;
                            // Undead
                            case RACE_UNDEAD_PLAYER:
                                target->SetDisplayId(gender == GENDER_MALE ? 25042 : 25053); // Undead
                                break;
                            // Draenei
                            case RACE_DRAENEI:
                                target->SetDisplayId(gender == GENDER_MALE ? 25033 : 25044); // Draenei
                                break;
                            // Dwarf
                            case RACE_DWARF:
                                target->SetDisplayId(gender == GENDER_MALE ? 25034 : 25045); // Dwarf
                                break;
                            // Gnome
                            case RACE_GNOME:
                                target->SetDisplayId(gender == GENDER_MALE ? 25035 : 25046); // Gnome
                                break;
                            // Human
                            case RACE_HUMAN:
                                target->SetDisplayId(gender == GENDER_MALE ? 25037 : 25048); // Human
                                break;
                            // Night Elf
                            case RACE_NIGHTELF:
                                target->SetDisplayId(gender == GENDER_MALE ? 25038 : 25049); // Night Elf
                                break;
                            // Goblin
                            case RACE_GOBLIN_:
                                target->SetDisplayId(gender == GENDER_MALE ? 18967 : 18968); // Goblin
                                break;
                            // Worgen
                            case RACE_WORGEN:
                                target->SetDisplayId(gender == GENDER_MALE ? 574 : 574); // Worgen
                                break;
                            // Pandaren Horde
                            case RACE_PANDAREN_HORDE:
                                target->SetDisplayId(gender == GENDER_MALE ? 150124 : 150106); // Pandaren Horde
                                break;
                            // Pandaren Alliance
                            case RACE_PANDAREN_ALLIANCE:
                                target->SetDisplayId(gender == GENDER_MALE ? 150124 : 150106); // Pandaren Alliance
                                break;
                            // Blood Elf Illidari
                            case RACE_BLOODELF_ILLIDARI:
                                target->SetDisplayId(gender == GENDER_MALE ? 25032 : 25043); // Blood Elf Illidari
                                break;
                            // Night Elf Illidari
                            case RACE_NIGHTELF_ILLIDARI:
                                target->SetDisplayId(gender == GENDER_MALE ? 25038 : 25049); // Night Elf Illidari
                                break;
                            // Eredar
                            case RACE_EREDAR:
                                target->SetDisplayId(gender == GENDER_MALE ? 25033 : 25044); // Eredar
                                break;
                            // Void Elf
                            case RACE_VOIDELF:
                                target->SetDisplayId(gender == GENDER_MALE ? 25032 : 25043); // Void Elf
                                break;
                            // Vulpera
                            case RACE_VULPERA:
                                target->SetDisplayId(gender == GENDER_MALE ? 150266 : 150266); // Vulpera
                                break;
                            // Nightborne
                            case RACE_NIGHTBORNE:
                                target->SetDisplayId(gender == GENDER_MALE ? 150264 : 150261); // Nightborne
                                break;
                            // Lightforged Draenei
                            case RACE_LIGHTFORGED_DRAENEI:
                                target->SetDisplayId(gender == GENDER_MALE ? 25033 : 25044); // Lightforged Draenei
                                break;
                            // Zandalari Troll
                            case RACE_ZANDALARI_TROLL:
                                target->SetDisplayId(gender == GENDER_MALE ? 25041 : 25052); // Zandalari Troll
                                break;
                            // Dark Iron Dwarf Alliance
                            case RACE_DARK_IRON_DWARF:
                                target->SetDisplayId(gender == GENDER_MALE ? 25034 : 25045); // Dark Iron Dwarf Alliance
                                break;
                            // Dark Iron Dwarf Horde
                            case RACE_DARK_IRON_DWARF_H:
                                target->SetDisplayId(gender == GENDER_MALE ? 25034 : 25045); // Dark Iron Dwarf Horde
                                break;
                            // High Elf Alliance
                            case RACE_HIGHELF:
                                target->SetDisplayId(gender == GENDER_MALE ? 36403 : 36404); // High Elf Alliance
                                break;
                            // High mountain Tauren Horde
                            case RACE_HIGHMOUNTAINTAUREN:
                                target->SetDisplayId(gender == GENDER_MALE ? 36405 : 36406); // High mountain Tauren Horde
                                break;
                            // Vulpera Alliance
                            case RACE_VULPERA_A:
                                target->SetDisplayId(gender == GENDER_MALE ? 36401 : 36402); // Vulpera Alliance
                                break;
                            // Human Horde
                            case RACE_DRACTHYR_H:
                                target->SetDisplayId(gender == GENDER_MALE ? 25037 : 25048); // Human Horde
                                break;
                            // Blood Elf Alliance
                            case RACE_DRACTHYR_A:
                                target->SetDisplayId(gender == GENDER_MALE ? 25032 : 25043); // Blood Elf Alliance
                                break;
                            // Mag'har Horde
                            case RACE_MAGHAR:
                                target->SetDisplayId(gender == GENDER_MALE ? 25033 : 25044); // Mag'har Horde
                                break;
                            // Kultiran Alliance
                            case RACE_KULTIRAN:
                                target->SetDisplayId(gender == GENDER_MALE ? 25033 : 25044); // Kultiran Alliance
                                break;
                            default:
                                break;
                        }
            ...
            else
            {
                ...
                if (!ci)
                {
                    ...
                    SC_LOG_ERROR("spells.aura.effect", "Auras: unknown creature id = {} (only need its modelid) From Spell Aura Transform in Spell ID = {}", GetMiscValue(), GetId());
                }
                else
                {
                    uint32 model_id = 0;
...
void AuraEffect::HandleFeignDeath(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    if (apply)
    {
        ...
        */
        ...
        UnitList targets;
        Syphrena::AnyUnfriendlyUnitInObjectRangeCheck u_check(target, target, target->GetMap()->GetVisibilityRange());
        Syphrena::UnitListSearcher<Syphrena::AnyUnfriendlyUnitInObjectRangeCheck> searcher(target, targets, u_check);
...
void AuraEffect::HandleAuraModStat(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    {
        SC_LOG_ERROR("spells.aura.effect", "WARNING: Spell {} effect {} has an unsupported misc value ({}) for SPELL_AURA_MOD_STAT ", GetId(), GetEffIndex(), GetMiscValue());
        return;
    }
...
void AuraEffect::HandleModPercentStat(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    {
        SC_LOG_ERROR("spells.aura.effect", "WARNING: Misc Value for SPELL_AURA_MOD_PERCENT_STAT not valid");
        return;
    }
...
void AuraEffect::HandleAuraModResistenceOfStatPercent(AuraApplication const* aurApp, uint8 mode, bool /*apply*/) const
{
    ...
    if (GetMiscValue() != SPELL_SCHOOL_MASK_NORMAL)
    {
        ...
        SC_LOG_ERROR("spells.aura.effect", "Aura SPELL_AURA_MOD_RESISTANCE_OF_STAT_PERCENT(182) does not work for non-armor type resistances!");
        return;
    }
...
void AuraEffect::HandlePeriodicTriggerSpellAuraTick(Unit* target, Unit* caster) const
{
    ...
    if (triggerSpellId == 0)
    {
        SC_LOG_WARN("spells.aura.effect.nospell", "AuraEffect::HandlePeriodicTriggerSpellAuraTick: Spell {} [EffectIndex: {}] does not have triggered spell.", GetId(), GetEffIndex());
        return;
    }
    ...
    if (SpellInfo const* triggeredSpellInfo = sSpellMgr->GetSpellInfo(triggerSpellId))
    {
        ...
        if (Unit* triggerCaster = triggeredSpellInfo->NeedsToBeTriggeredByCaster(m_spellInfo) ? caster : target)
        {
            ...
            SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandlePeriodicTriggerSpellAuraTick: Spell {} Trigger {}", GetId(), triggeredSpellInfo->Id);
        }
    }
    else
    {
        SC_LOG_ERROR("spells.aura.effect.nospell", "AuraEffect::HandlePeriodicTriggerSpellAuraTick: Spell {} has non-existent spell {} in EffectTriggered[{}] and is therefore not triggered.", GetId(), triggerSpellId, GetEffIndex());
    }
}
...
void AuraEffect::HandlePeriodicTriggerSpellWithValueAuraTick(Unit* target, Unit* caster) const
{
    ...
    if (triggerSpellId == 0)
    {
        SC_LOG_WARN("spells.aura.effect.nospell", "AuraEffect::HandlePeriodicTriggerSpellWithValueAuraTick: Spell {} [EffectIndex: {}] does not have triggered spell.", GetId(), GetEffIndex());
        return;
    }
    ...
    if (SpellInfo const* triggeredSpellInfo = sSpellMgr->GetSpellInfo(triggerSpellId))
    {
        ...
        if (Unit* triggerCaster = triggeredSpellInfo->NeedsToBeTriggeredByCaster(m_spellInfo) ? caster : target)
        {
            ...
            SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandlePeriodicTriggerSpellWithValueAuraTick: Spell {} Trigger {}", GetId(), triggeredSpellInfo->Id);
        }
    }
    else
        SC_LOG_ERROR("spells.aura.effect.nospell","AuraEffect::HandlePeriodicTriggerSpellWithValueAuraTick: Spell {} has non-existent spell {} in EffectTriggered[{}] and is therefore not triggered.", GetId(), triggerSpellId, GetEffIndex());
}
...
void AuraEffect::HandlePeriodicDamageAurasTick(Unit* target, Unit* caster) const
{
    ...
    SC_LOG_DEBUG("spells.aura.effect", "PeriodicTick: {} attacked {} for {} dmg inflicted by {} absorb is {}",
...
void AuraEffect::HandlePeriodicHealthLeechAuraTick(Unit* target, Unit* caster) const
{
    ...
    uint32 absorb = damageInfo.GetAbsorb();
    uint32 resist = damageInfo.GetResist();
    SC_LOG_DEBUG("spells.aura.effect", "PeriodicTick: {} health leech of {} for {} dmg inflicted by {} abs is {}",
        GetCasterGUID().ToString(), target->GetGUID().ToString(), damage, GetId(), absorb);
...
void AuraEffect::HandlePeriodicHealthFunnelAuraTick(Unit* target, Unit* caster) const
{
    ...
    SC_LOG_DEBUG("spells.aura.effect", "PeriodicTick: donator {} target {} damage {}.", caster->GetEntry(), target->GetEntry(), damage);
...
void AuraEffect::HandlePeriodicHealAurasTick(Unit* target, Unit* caster) const
{
    ...
    SC_LOG_DEBUG("spells.aura.effect", "PeriodicTick: {} heal of {} for {} health inflicted by {}",
...
void AuraEffect::HandlePeriodicManaLeechAuraTick(Unit* target, Unit* caster) const
{
    ...
    SC_LOG_DEBUG("spells.aura.effect", "PeriodicTick: {} power leech of {} for {} dmg inflicted by {}",
...
void AuraEffect::HandleObsModPowerAuraTick(Unit* target, Unit* caster) const
{
    ...
    SC_LOG_DEBUG("spells.aura.effect", "PeriodicTick: {} energize {} for {} dmg inflicted by {}",
...
void AuraEffect::HandleProcTriggerSpellAuraProc(AuraApplication* aurApp, ProcEventInfo& eventInfo)
{
    ...
    if (triggerSpellId == 0)
    {
        SC_LOG_WARN("spells.aura.effect.nospell", "AuraEffect::HandleProcTriggerSpellAuraProc: Spell {} [EffectIndex: {}] does not have triggered spell.", GetId(), GetEffIndex());
        return;
    }

    if (SpellInfo const* triggeredSpellInfo = sSpellMgr->GetSpellInfo(triggerSpellId))
    {
        SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandleProcTriggerSpellAuraProc: Triggering spell {} from aura {} proc", triggeredSpellInfo->Id, GetId());
        ...
        SC_LOG_ERROR("spells.aura.effect.nospell","AuraEffect::HandleProcTriggerSpellAuraProc: Spell {} has non-existent spell {} in EffectTriggered[{}] and is therefore not triggered.", GetId(), triggerSpellId, GetEffIndex());
}
...
void AuraEffect::HandleProcTriggerSpellWithValueAuraProc(AuraApplication* aurApp, ProcEventInfo& eventInfo)
{
    ...
    if (SpellInfo const* triggeredSpellInfo = sSpellMgr->GetSpellInfo(triggerSpellId))
    {
        ...
        args.AddSpellMod(SPELLVALUE_BASE_POINT0, GetAmount());
        triggerCaster->CastSpell(triggerTarget, triggerSpellId, args);
        SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandleProcTriggerSpellWithValueAuraProc: Triggering spell {} with value {} from aura {} proc", triggeredSpellInfo->Id, GetAmount(), GetId());
    }
    else
        SC_LOG_ERROR("spells.aura.effect.nospell","AuraEffect::HandleProcTriggerSpellWithValueAuraProc: Spell {} has non-existent spell {} in EffectTriggered[{}] and is therefore not triggered.", GetId(), triggerSpellId, GetEffIndex());
}
...
void AuraEffect::HandleProcTriggerDamageAuraProc(AuraApplication* aurApp, ProcEventInfo& eventInfo)
{
    ...
    SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandleProcTriggerDamageAuraProc: Triggering {} spell damage from aura {} proc", damage, GetId());
...
void AuraEffect::HandleRaidProcFromChargeAuraProc(AuraApplication* aurApp, ProcEventInfo& /*eventInfo*/)
{
    ...
    switch (GetId())
    {
        ...
        case 43593:            // Cold Stare
            ...
            break;
        default:
            SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandleRaidProcFromChargeAuraProc: received not handled spell: {}", GetId());
            return;
    }
    ...
    SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandleRaidProcFromChargeAuraProc: Triggering spell {} from aura {} proc", triggerSpellId, GetId());
...
void AuraEffect::HandleRaidProcFromChargeWithValueAuraProc(AuraApplication* aurApp, ProcEventInfo& /*eventInfo*/)
{
    ...
    {
        SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandleRaidProcFromChargeWithValueAuraProc: received not handled spell: {}", GetId());
        return;
    }
    ...
    if (jumps > 0)
    {
        if (Unit* caster = GetCaster())
        {
            ...
            Syphrena::MostHPMissingGroupInRange u_check(target, radius, 0);
            Syphrena::UnitLastSearcher<Syphrena::MostHPMissingGroupInRange> searcher(target, triggerTarget, u_check);
    ...
    SC_LOG_DEBUG("spells.aura.effect", "AuraEffect::HandleRaidProcFromChargeWithValueAuraProc: Triggering spell {} from aura {} proc", triggerSpellId, GetId());
...
template SC_GAME_API void AuraEffect::GetTargetList(std::list<Unit*>&) const;
template SC_GAME_API void AuraEffect::GetTargetList(std::deque<Unit*>&) const;
template SC_GAME_API void AuraEffect::GetTargetList(std::vector<Unit*>&) const;

template SC_GAME_API void AuraEffect::GetApplicationList(std::list<AuraApplication*>&) const;
template SC_GAME_API void AuraEffect::GetApplicationList(std::deque<AuraApplication*>&) const;
template SC_GAME_API void AuraEffect::GetApplicationList(std::vector<AuraApplication*>&) const;
