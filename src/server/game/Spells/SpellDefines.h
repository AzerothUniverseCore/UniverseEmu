...
#ifndef SYPHRENA_SPELLDEFINES_H
#define SYPHRENA_SPELLDEFINES_H
...
struct SC_GAME_API SpellDestination
{
    SpellDestination();
...
class SC_GAME_API SpellCastTargets
{
public:
    SpellCastTargets();
    ~SpellCastTargets();
...
struct SC_GAME_API CastSpellTargetArg
{
...
struct SC_GAME_API CastSpellExtraArgs
{
    CastSpellExtraArgs() {}
