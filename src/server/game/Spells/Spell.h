...
class SC_GAME_API Spell
{
    ...
    public:
        ...
        Syphrena::unique_weak_ptr<Spell> GetWeakPtr() const;
...
namespace Syphrena
{
    struct SC_GAME_API WorldObjectSpellTargetCheck
    {
        protected:
            WorldObject* _caster;
    ...
    struct SC_GAME_API WorldObjectSpellNearbyTargetCheck : public WorldObjectSpellTargetCheck
    {
        float _range;
    ...
    struct SC_GAME_API WorldObjectSpellAreaTargetCheck : public WorldObjectSpellTargetCheck
    {
        float _range;
        Position const* _position;
    ...
    struct SC_GAME_API WorldObjectSpellConeTargetCheck : public WorldObjectSpellAreaTargetCheck
    {
        float _coneAngle;
    ...
    struct SC_GAME_API WorldObjectSpellTrajTargetCheck : public WorldObjectSpellTargetCheck
    {
        float _range;
        Position const* _position;
