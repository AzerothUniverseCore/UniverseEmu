...
struct SpellEffectInfo::ImmunityInfo
{
    ...
    Syphrena::Containers::FlatSet<AuraType> AuraTypeImmune;
    Syphrena::Containers::FlatSet<SpellEffects> SpellEffectImmune;
};
...
SpellCastResult SpellInfo::CheckShapeshift(uint32 form) const
{
    ...
    if (form > 0)
    {
        ...
        if (!shapeInfo)
        {
            SC_LOG_ERROR("spells", "GetErrorAtShapeshiftedCast: unknown shapeshift {}", form);
            return SPELL_CAST_OK;
        }
...
void SpellInfo::_LoadSpellDiminishInfo()
{
    auto diminishingGroupCompute = [this](bool triggered) -> DiminishingGroup
    {
        ...
        /*if (mechanic & (1 << MECHANIC_INCAPACITATE))
            return DIMINISHING_INCAPACITATE;*/
...
int32 SpellInfo::CalcPowerCost(WorldObject const* caster, SpellSchoolMask schoolMask, Spell* spell) const
{
    ...
    if (HasAttribute(SPELL_ATTR1_DRAIN_ALL_POWER))
    {
        ...
        SC_LOG_ERROR("spells", "SpellInfo::CalcPowerCost: Unknown power type '{}' in spell {}", PowerType, Id);
        return 0;
    }
    ...
    if (ManaCostPercentage)
    {
        switch (PowerType)
        {
            ...
            case POWER_RUNIC_POWER:
                SC_LOG_DEBUG("spells", "CalculateManaCost: Not implemented yet!");
                break;
            default:
                SC_LOG_ERROR("spells", "CalculateManaCost: Unknown power type '{}' in spell {}", PowerType, Id);
                return 0;
        }
    }
