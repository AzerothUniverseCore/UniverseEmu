...
enum RBACPermissions
{
    ...
    RBAC_PERM_SKIP_CHECK_CHARACTER_CREATION_DEMON_HUNTER     = 12, // implemanted on 3.3.5a
    ...
    RBAC_ROLE_BETA_TESTER_ADMINISTRATOR                      = 188,
    RBAC_ROLE_BETA_TESTER_GAMEMASTER                         = 189,
    RBAC_ROLE_BETA_TESTER_MODERATOR                          = 190,
    RBAC_ROLE_BETA_TESTER_PLAYER                             = 191,
    ...
    RBAC_PERM_COMMAND_RELOAD_SYPHRENA_STRING                 = 704,
    ...
    RBAC_PERM_COMMAND_RELOAD_ITEM_TEMPLATEALL                = 1700,
    RBAC_PERM_COMMAND_RELOAD_CREATURE_TEMPLATEALL            = 1701,
    RBAC_PERM_COMMAND_RELOAD_GAMEOBJECT_TEMPLATEALL          = 1702,
    RBAC_PERM_COMMAND_RELOAD_TEMPLATENPC                     = 1703,
...
class SC_GAME_API RBACPermission
{
    public:
...
class SC_GAME_API RBACData
{
    public:
         ...
         *     SC_LOG_DEBUG("entities.player", "Failed to grant permission {}, already denied", permissionId);
         * @endcode
         */
         ...
         *     SC_LOG_DEBUG("entities.player", "Role Id {} does not exists", permissionId);
         * @endcode
         */
         ...
         *     SC_LOG_DEBUG("entities.player", "Permission {} succesfully removed", permissionId);
         * @endcode
         */
