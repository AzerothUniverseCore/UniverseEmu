...
#ifndef SYPHRENA_DISABLEMGR_H
#define SYPHRENA_DISABLEMGR_H
...
{
    SC_GAME_API void LoadDisables();
    SC_GAME_API bool IsDisabledFor(DisableType type, uint32 entry, WorldObject const* ref, uint8 flags = 0);
    SC_GAME_API void CheckQuestDisables();
    SC_GAME_API bool IsVMAPDisabledFor(uint32 entry, uint8 flags);
    SC_GAME_API bool IsPathfindingEnabled(uint32 mapId);
}

#endif //SYPHRENA_DISABLEMGR_H
