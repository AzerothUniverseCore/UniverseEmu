...
#ifndef SYPHRENA_CONDITIONMGR_H
#define SYPHRENA_CONDITIONMGR_H
...
struct SC_GAME_API ConditionSourceInfo
{
...
class SC_GAME_API ConditionMgr
{
    private:
        ConditionMgr();
        ~ConditionMgr();
