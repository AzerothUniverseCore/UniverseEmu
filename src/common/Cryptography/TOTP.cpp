...
constexpr std::size_t Syphrena::Crypto::TOTP::RECOMMENDED_SECRET_LENGTH;
static constexpr uint32 TOTP_INTERVAL = 30;
static constexpr uint32 HMAC_RESULT_SIZE = 20;
/*static*/ uint32 Syphrena::Crypto::TOTP::GenerateToken(Secret const& secret, time_t timestamp)
{
...
/*static*/ bool Syphrena::Crypto::TOTP::ValidateToken(Secret const& secret, uint32 token)
{
