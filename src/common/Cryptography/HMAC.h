...
#ifndef SYPHRENA_HMAC_H
#define SYPHRENA_HMAC_H
...
{
    using HMAC_SHA1 = Syphrena::Impl::GenericHMAC<EVP_sha1, Constants::SHA1_DIGEST_LENGTH_BYTES>;
    using HMAC_SHA256 = Syphrena::Impl::GenericHMAC<EVP_sha256, Constants::SHA256_DIGEST_LENGTH_BYTES>;
}
#endif
