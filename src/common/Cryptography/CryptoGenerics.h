...
#ifndef SYPHRENA_CRYPTO_GENERICS_HPP
#define SYPHRENA_CRYPTO_GENERICS_HPP
...
namespace Syphrena::Impl
{
    struct CryptoGenericsImpl
    {
        ...
        static typename Cipher::IV GenerateRandomIV()
        {
            ...
            Syphrena::Crypto::GetRandomBytes(iv);
            return iv;
        }
...
namespace Syphrena::Crypto
{
    ...
    void AEEncryptWithRandomIV(std::vector<uint8>& data, typename Cipher::Key const& key)
    {
        ...
        // select random IV
        IV iv = Syphrena::Impl::CryptoGenericsImpl::GenerateRandomIV<Cipher>();
        Tag tag;
        ...
        Syphrena::Impl::CryptoGenericsImpl::AppendToBack(data, iv);
        Syphrena::Impl::CryptoGenericsImpl::AppendToBack(data, tag);
    }
    ...
    bool AEDecrypt(std::vector<uint8>& data, typename Cipher::Key const& key)
    {
        ...
        IV iv;
        Tag tag;
        Syphrena::Impl::CryptoGenericsImpl::SplitFromBack(data, tag);
        Syphrena::Impl::CryptoGenericsImpl::SplitFromBack(data, iv);
