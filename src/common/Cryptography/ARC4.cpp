...
Syphrena::Crypto::ARC4::ARC4() : _ctx(EVP_CIPHER_CTX_new())
{
...
void Syphrena::Crypto::ARC4::Init(uint8 const* seed, size_t len)
{
...
void Syphrena::Crypto::ARC4::UpdateData(uint8* data, size_t len)
{
    int outlen = 0;
