...
#ifndef SYPHRENA_CRYPTOHASH_H
#define SYPHRENA_CRYPTOHASH_H
...
{
    using MD5 = Syphrena::Impl::GenericHash<EVP_md5, Constants::MD5_DIGEST_LENGTH_BYTES>;
    using SHA1 = Syphrena::Impl::GenericHash<EVP_sha1, Constants::SHA1_DIGEST_LENGTH_BYTES>;
    using SHA256 = Syphrena::Impl::GenericHash<EVP_sha256, Constants::SHA256_DIGEST_LENGTH_BYTES>;
}
