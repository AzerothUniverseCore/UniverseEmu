...
#ifndef SYPHRENA_STRINGCONVERT_H
#define SYPHRENA_STRINGCONVERT_H
...
namespace Syphrena::Impl::StringConvertImpl
{
    template <typename T, typename = void> struct For
    {
        static_assert(Syphrena::dependant_false_v<T>, "Unsupported type used for ToString or StringTo");
        /*
...
#ifdef SYPHRENA_NEED_CHARCONV_WORKAROUND
    /*
...
namespace Syphrena
{
    ...
    {
        return Syphrena::Impl::StringConvertImpl::For<Result>::FromString(str, std::forward<Params>(params)...);
    }

    template <typename Type, typename... Params>
    std::string ToString(Type&& val, Params&&... params)
    {
        return Syphrena::Impl::StringConvertImpl::For<std::decay_t<Type>>::ToString(std::forward<Type>(val), std::forward<Params>(params)...);
    }
}
