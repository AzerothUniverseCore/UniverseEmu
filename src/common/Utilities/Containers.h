...
#ifndef SYPHRENA_CONTAINERS_H
#define SYPHRENA_CONTAINERS_H
...
namespace Syphrena
{
    ...
    namespace Containers
    {
        ...
        {
            static_assert(std::is_base_of<std::forward_iterator_tag, typename std::iterator_traits<typename C::iterator>::iterator_category>::value, "Invalid container passed to Syphrena::Containers::RandomResize");
        ...
        /**
         * @fn void Syphrena::Containers::RandomShuffle(C& container)
         *
        ...
        /**
         * @fn bool Syphrena::Containers::Intersects(Iterator first1, Iterator last1, Iterator first2, Iterator last2)
         *
...
#endif //! #ifdef SYPHRENA_CONTAINERS_H
