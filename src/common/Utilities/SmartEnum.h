...
#ifndef SYPHRENA_SMARTENUM_H
#define SYPHRENA_SMARTENUM_H
...
class EnumUtils
{
    public:
        template <typename Enum>
        static size_t Count() { return Syphrena::Impl::EnumUtilsImpl::EnumUtils<Enum>::Count(); }
        template <typename Enum>
        static EnumText ToString(Enum value) { return Syphrena::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToString(value); }
        template <typename Enum>
        static Enum FromIndex(size_t index) { return Syphrena::Impl::EnumUtilsImpl::EnumUtils<Enum>::FromIndex(index); }
        template <typename Enum>
        static uint32 ToIndex(Enum value) { return Syphrena::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToIndex(value);}
        ...
        static bool IsValid(Enum value)
        {
            try
            {
                Syphrena::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToIndex(value);
                return true;
            } catch (...)
            {
                return false;
        ...
        template <typename Enum>
        static Syphrena::IteratorPair<Iterator<Enum>> Iterate() { return { Begin<Enum>(), End<Enum>() }; }
