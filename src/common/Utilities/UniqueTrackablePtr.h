...
#ifndef SYPHRENACORE_UNIQUE_TRACKABLE_PTR_H
#define SYPHRENACORE_UNIQUE_TRACKABLE_PTR_H
...
/**
 * \brief Syphrena::unique_trackable_ptr companion class, replicating what std::weak_ptr is to std::shared_ptr
 * \tparam T Type of held object
 */
template <typename T>
class unique_weak_ptr
...
#endif // SYPHRENACORE_UNIQUE_TRACKABLE_PTR_H