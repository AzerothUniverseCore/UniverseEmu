...
#ifndef SyphrenaCore_Hash_h__
#define SyphrenaCore_Hash_h__
...
namespace std
{
    ...
    public:
        ...
        {
            size_t hashVal = 0;
            Syphrena::hash_combine(hashVal, p.first);
            Syphrena::hash_combine(hashVal, p.second);
            return hashVal;
        }
    };
}

#endif // SyphrenaCore_Hash_h__
