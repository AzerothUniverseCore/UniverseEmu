...
namespace Syphrena
{
    ...
    /*
        ...
        struct Example
        {
            using TupleArg = Syphrena::find_type_if_t<Syphrena::is_tuple, Ts...>;

            bool HasTuple()
            {
                return !std::is_same_v<TupleArg, Syphrena::find_type_end>;
            }
        };
        ...
        example2.HasTuple() == false; // TupleArg is Syphrena::find_type_end
    */
    template<template<typename...> typename Check, typename... Ts>
