...
class SC_COMMON_API GameObjectModelOwnerBase
{
public:
...
class SC_COMMON_API GameObjectModel /*, public Intersectable*/
{
...
SC_COMMON_API void LoadGameObjectModelList(std::string const& dataPath);
