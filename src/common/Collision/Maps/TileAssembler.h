...
namespace VMAP
{
    ...
    */
    ...
    class SC_COMMON_API ModelPosition
    {
        private:
    ...
    struct SC_COMMON_API MapSpawns
    {
    ...
    struct SC_COMMON_API GroupModel_Raw
    {
        uint32 mogpflags;
        uint32 GroupWMOID;
    ...
    struct SC_COMMON_API WorldModel_Raw
    {
        uint32 RootWMOID;
    ...
    class SC_COMMON_API TileAssembler
    {
        private:
            std::string iDestDir;
            std::string iSrcDir;
