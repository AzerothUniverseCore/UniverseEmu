...
/*static*/ std::string Syphrena::Encoding::Base32::Encode(std::vector<uint8> const& data)
{
    return Syphrena::Impl::GenericBaseEncoding<B32Impl>::Encode(data);
}

/*static*/ Optional<std::vector<uint8>> Syphrena::Encoding::Base32::Decode(std::string const& data)
{
    return Syphrena::Impl::GenericBaseEncoding<B32Impl>::Decode(data);
}
