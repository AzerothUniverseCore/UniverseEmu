...
/*static*/ std::string Syphrena::Encoding::Base64::Encode(std::vector<uint8> const& data)
{
    return Syphrena::Impl::GenericBaseEncoding<B64Impl>::Encode(data);
}

/*static*/ Optional<std::vector<uint8>> Syphrena::Encoding::Base64::Decode(std::string const& data)
{
    return Syphrena::Impl::GenericBaseEncoding<B64Impl>::Decode(data);
}
