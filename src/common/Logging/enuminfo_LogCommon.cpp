...
\************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<LogLevel>::ToString(LogLevel value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<LogLevel>::Count() { return 7; }

template <>
SC_API_EXPORT LogLevel EnumUtils<LogLevel>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<LogLevel>::ToIndex(LogLevel value)
{
    switch (value)
    {
...
\****************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<AppenderType>::ToString(AppenderType value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<AppenderType>::Count() { return 4; }

template <>
SC_API_EXPORT AppenderType EnumUtils<AppenderType>::FromIndex(size_t index)
{
    switch (index)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<AppenderType>::ToIndex(AppenderType value)
{
    switch (value)
    {
