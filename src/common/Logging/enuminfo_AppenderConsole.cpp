...
\********************************************************************/
template <>
SC_API_EXPORT EnumText EnumUtils<ColorTypes>::ToString(ColorTypes value)
{
    switch (value)
    {
...
template <>
SC_API_EXPORT size_t EnumUtils<ColorTypes>::Count() { return 15; }

template <>
SC_API_EXPORT ColorTypes EnumUtils<ColorTypes>::FromIndex(size_t index)
{
    switch (index)
    {
        case 0: return BLACK;
...
template <>
SC_API_EXPORT size_t EnumUtils<ColorTypes>::ToIndex(ColorTypes value)
{
    switch (value)
    {
        case BLACK: return 0;
